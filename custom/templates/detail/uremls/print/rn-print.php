	 ...
	 <div class="bt-print__left">
		...
		<div class="bt-print__block">
		   ...
		   <p>
			  ...
			  <strong>School Private</strong>
			  [unmapped_schoolprivate]
			  <?php endif; ?>
		...
		<div class="bt-print__block">
			...
			<p>
			  ...
			  <strong>Carport Capacity</strong>
			  [unmapped_capcarport]
			  <?php endif; ?>
		...
		<div class="bt-print__block">
		   ...
		   <p>
			  ...
			  <strong>Basement Finished Percentage</strong>
			  [unmapped_basmntfin]
			  <?php endif; ?>
