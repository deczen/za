	...
	<li class="cell">
		...
		<table class="zy-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="zy-listing__table__label">Accessibiiity</td>
				...
				<tr>
					<td class="zy-listing__table__label">Deposit Amount</td>
					<td class="zy-listing__table__items"><span>[unmapped_depositamount]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Pets</td>
					<td class="zy-listing__table__items"><span>[petrestrictionsallow]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">School Private</td>
					<td class="zy-listing__table__items"><span>[unmapped_schoolprivate]</span></td>
				</tr>
				<?php endif; ?>
