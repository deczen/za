<ul class="grid grid--gutters grid-xs--full grid-lg--thirds">
	...
	<?php if( isset($single_property->handicapaccess) || isset($single_property->amenities) || isset($single_property->unmapped->hascommunitypool) || isset($single_property->unmapped->depositamount) || isset($single_property->petrestrictionsallow) || isset($single_property->unmapped->ownertype) || isset($single_property->asscpool) || isset($single_property->possession) || isset($single_property->unmapped->schoolprivate) || isset($single_property->unmapped->hasspa) || isset($single_property->unmapped->telcom) || isset($single_property->utilities) || isset($single_property->unmapped->watershares) || isset($single_property->zoning) || isset($single_property->heating) || isset($single_property->water) || isset($single_property->garagespaces) || isset($single_property->garageparking) || isset($single_property->parkingspaces) ):?>
	...
	<li class="cell">
		...
		<table class="bt-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="bt-listing__table__label">Accessibiiity</td>
				...
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->depositamount)): ?>
				<tr>
					<td class="bt-listing__table__label">Deposit Amount</td>
					<td class="bt-listing__table__items"><span>[unmapped_depositamount]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->maintfree)): ?>
				<tr>
					<td class="bt-listing__table__label">Maintenance Fee</td>
					<td class="bt-listing__table__items"><span>[unmapped_maintfree]</span></td> <!-- not done -->
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Pets</td>
					<td class="bt-listing__table__items"><span>[petrestrictionsallow]</span></td>
				</tr>
				<?php endif; ?>
				...
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->schoolprivate)): ?>
				<tr>
					<td class="bt-listing__table__label">School Private</td>
					<td class="bt-listing__table__items"><span>[unmapped_schoolprivate]</span></td>
				</tr>
				<?php endif; ?>
		...
		<?php if( isset($single_property->heating) || isset($single_property->water) ):?>
		...
		<table class="bt-listing__table">
			<tbody>
				...
				<tr>
					<td class="bt-listing__table__label">Garage Capacity</td>
	...
	<?php if( isset($single_property->unmapped->capcarport) || isset($single_property->unmapped->deck) || isset($single_property->unmapped->driveway) || isset($single_property->exterior) || isset($single_property->exteriorfeatures) || isset($single_property->landdesc) || isset($single_property->unmapped->dimback) || isset($single_property->unmapped->dimside) || isset($single_property->lotdescription) || isset($single_property->unmapped->patio) || isset($single_property->pooldescription) || isset($single_property->roofmaterial) || isset($single_property->unmapped->storage) || isset($single_property->style) || isset($single_property->taxes) || isset($single_property->homeownassociation) || isset($single_property->hoafee) || isset($single_property->asscfeeincludes) ):?>
	
	<li class="cell">
		
		<?php if( isset($single_property->unmapped->capcarport) || isset($single_property->unmapped->deck) || isset($single_property->unmapped->driveway) || isset($single_property->exterior) || isset($single_property->exteriorfeatures) || isset($single_property->landdesc) || isset($single_property->unmapped->dimback) || isset($single_property->unmapped->dimside) || isset($single_property->lotdescription) || isset($single_property->unmapped->patio) || isset($single_property->pooldescription) || isset($single_property->roofmaterial) || isset($single_property->unmapped->storage) || isset($single_property->style) ):?>
		...
		<table class="bt-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="bt-listing__table__label">Carport Capacity</td>
					<td class="bt-listing__table__items"><span>[unmapped_capcarport]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->deck)): ?>
				<tr>
					<td class="bt-listing__table__label">Decks</td>
					<td class="bt-listing__table__items"><span>[unmapped_deck]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Patios</td>
					<td class="bt-listing__table__items"><span>[unmapped_patio]</span></td>
				</tr>
				<?php endif; ?>
		...
		<?php if( isset($single_property->taxes) || isset($single_property->homeownassociation) || isset($single_property->hoafee) || isset($single_property->asscfeeincludes) ):?>
	...
	<li class="cell">
		...
		<?php if( isset($single_property->aircondition) || isset($single_property->basement) || isset($single_property->unmapped->basmntfin) || isset($single_property->flooring) || isset($single_property->interiorfeatures) || isset($single_property->unmapped->levbbed) || isset($single_property->unmapped->levbbathfull) || isset($single_property->unmapped->levbbathhalf) || isset($single_property->unmapped->levbsqf) || isset($single_property->unmapped->levbbathtq) || isset($single_property->unmapped->lev1bed) || isset($single_property->unmapped->lev1bathfull) || isset($single_property->unmapped->lev1bathhalf) || isset($single_property->unmapped->lev1sqf) || isset($single_property->unmapped->lev1bathtq) || isset($single_property->unmapped->lev2bed) || isset($single_property->unmapped->lev2bathfull) || isset($single_property->unmapped->lev2bathhalf) || isset($single_property->unmapped->lev2sqf) || isset($single_property->unmapped->lev2bathtq) || isset($single_property->unmapped->lev3bed) || isset($single_property->unmapped->lev3bathfull) || isset($single_property->unmapped->lev3bathhalf) || isset($single_property->unmapped->lev3sqf) || isset($single_property->unmapped->lev3bathtq) || isset($single_property->unmapped->lev4bed) || isset($single_property->unmapped->lev4bathfull) || isset($single_property->unmapped->lev4bathhalf) || isset($single_property->unmapped->lev4sqf) || isset($single_property->unmapped->lev4bathtq) || isset($single_property->nobaths) || isset($single_property->unmapped->totkitchenb) || isset($single_property->unmapped->totden) || isset($single_property->unmapped->totfamroom) || isset($single_property->fireplaces) || isset($single_property->unmapped->totdiningf) || isset($single_property->unmapped->nolivinglevels) || isset($single_property->unmapped->totkitchenk) || isset($single_property->unmapped->totlaundry) || isset($single_property->unmapped->windows) ):?>
		...
		<table class="bt-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="bt-listing__table__label">Air Conditioning</td>
				...
				<tr>
					<td class="bt-listing__table__label">Basement Finished Percentage</td>
					<td class="bt-listing__table__items"><span>[unmapped_basmntfin]</span></td>
				</tr>
				<?php endif; ?>
