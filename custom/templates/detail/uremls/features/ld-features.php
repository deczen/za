	...
	<li class="cell">
		...
		<table class="zy-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="zy-listing__table__label">Farm Type</td>
					<td class="zy-listing__table__items"><span>[propsubtype]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->improvements)): ?> <!-- -->
				<tr>
					<td class="zy-listing__table__label">Improvements</td>
					<td class="zy-listing__table__items"><span>[unmapped_improvements]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->irrigation)): ?>
				<tr>
					<td class="zy-listing__table__label">Irrigation </td>
					<td class="zy-listing__table__items"><span>[unmapped_irrigation]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					...
					<td class="zy-listing__table__items"><span>[unmapped_termsfeature]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					...
					<td class="zy-listing__table__items"><span>[unmapped_waterviewfeatures]</span></td>
				</tr>
				<?php endif; ?>
	...
	<li class="cell">
		...
		<table class="zy-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="zy-listing__table__label">Acres Dry</td>
					<td class="zy-listing__table__items"><span>[unmapped_acresdry]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->acresirrig)): ?>
				<tr>
					<td class="zy-listing__table__label">Acres Irrigated</td>
					<td class="zy-listing__table__items"><span>[unmapped_acresirrig]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->acresleased)): ?>
				<tr>
					<td class="zy-listing__table__label">Acres Leased</td>
					<td class="zy-listing__table__items"><span>[unmapped_acresleased]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->acresrange)): ?>
				<tr>
					<td class="zy-listing__table__label">Acres Range</td>
					<td class="zy-listing__table__items"><span>[unmapped_acresrange]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Land Use</td>
				...
				<tr>
					<td class="zy-listing__table__label">Lot Facts</td>
