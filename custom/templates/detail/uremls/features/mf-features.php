	...
	<li class="cell">
		...
		<table class="zy-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="zy-listing__table__label">Additional Information </td>
					<td class="zy-listing__table__items"><span>[unmapped_additinfo]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->grossoper)): ?>
				<tr>
					<td class="zy-listing__table__label">Gross Operating </td>
					<td class="zy-listing__table__items"><span>[unmapped_grossoper]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->yearlyoccup)): ?>
				<tr>
					<td class="zy-listing__table__label">Yearly Occupancy</td>
					<td class="zy-listing__table__items"><span>[unmapped_yearlyoccup]</span></td>
				</tr>
				<?php endif; ?>
