	...
	<li class="cell">
		...
		<table class="zy-listing__table">
			...
			<tbody>
				<?php if( isset($single_property->unmapped->businessname)): ?>
				<tr>
					<td class="zy-listing__table__label">Business Name</td>
					<td class="zy-listing__table__items"><span>[unmapped_businessname]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->caprate)): ?>
				<tr>
					<td class="zy-listing__table__label">Capitalization Rate</td>
					<td class="zy-listing__table__items"><span>[unmapped_caprate]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->leasetermsfrom)): ?>
				<tr>
					<td class="zy-listing__table__label">Lease Terms From</td>
					<td class="zy-listing__table__items"><span>[unmapped_leasetermsfrom]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->leasetermsto)): ?>
				<tr>
					<td class="zy-listing__table__label">Lease Terms To</td>
					<td class="zy-listing__table__items"><span>[unmapped_leasetermsto]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Sublease From </td>
					<td class="zy-listing__table__items"><span>[unmapped_subleasefrom]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->subleaseto)): ?>
				<tr>
					<td class="zy-listing__table__label">Sublease To</td>
					<td class="zy-listing__table__items"><span>[unmapped_subleaseto]</span></td>
				</tr>
				<?php endif; ?>
