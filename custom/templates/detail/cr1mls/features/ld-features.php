	...
	<li class="cell">
		...
		<table class="bt-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="bt-listing__table__label">Total Units</td>
					<td class="bt-listing__table__items"><span>[totalunits]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->totalbldgsf)): ?>
				<tr>
					<td class="bt-listing__table__label">Total bldgsf</td>
					<td class="bt-listing__table__items"><span>[totalbldgsf]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Fireplace YN</td>
				...
				<tr>
					<td class="bt-listing__table__label">Living Area</td>
					<td class="bt-listing__table__items"><span>[unmapped_LivingArea]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Spa Features</td>
					<td class="bt-listing__table__items"><span>[unmapped_SpaFeatures]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Uncovered Spaces</td>
					<td class="bt-listing__table__items"><span>[unmapped_UncoveredSpaces]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					...
					<td class="bt-listing__table__items"><span>[unmapped_GrossOperatingIncome]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->ImprovementsAmount)): ?>
				<tr>
					<td class="bt-listing__table__label">Improvements Amount</td>
					<td class="bt-listing__table__items"><span>[unmapped_ImprovementsAmount]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->GrossMultiplier)): ?>
				<tr>
					<td class="bt-listing__table__label">Gross Multiplier</td>
					<td class="bt-listing__table__items"><span>[unmapped_GrossMultiplier]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->LandValue)): ?>
				<tr>
					<td class="bt-listing__table__label">Land Value</td>
					<td class="bt-listing__table__items"><span>[unmapped_LandValue]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->grossannualexp)): ?>
				<tr>
					<td class="bt-listing__table__label">Gross Annual exp</td>
					<td class="bt-listing__table__items"><span>[grossannualexp]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->GrossScheduledIncome)): ?>
				<tr>
					<td class="bt-listing__table__label">Gross Scheduled Income</td>
					<td class="bt-listing__table__items"><span>[unmapped_GrossScheduledIncome]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->ProfessionalManagementExpense)): ?>
				<tr>
					<td class="bt-listing__table__label">Professional Management Expense</td>
					<td class="bt-listing__table__items"><span>[unmapped_ProfessionalManagementExpense]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->netoperatinginc)): ?>
				<tr>
					<td class="bt-listing__table__label">Net Operating inc</td>
					<td class="bt-listing__table__items"><span>[netoperatinginc]</span></td>
				</tr>
				<?php endif; ?>
		...
		<table class="bt-listing__table">
			...
			<tbody>
				...
				<tr>
					...
					<td class="bt-listing__table__items"><span>[unmapped_ASSOCSECURITY]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Asscpool</td>
	...
	<?php if( isset($single_property->heating) || isset($single_property->cooling) || isset($single_property->sewer) || isset($single_property->water) || isset($single_property->unmapped->NumberOfSeparateElectricMeters) || isset($single_property->unmapped->NumberOfSeparateWaterMeters) || isset($single_property->unmapped->NumberOfSeparateGasMeters) || isset($single_property->unmapped->FuelExpense) || isset($single_property->unmapped->ElectricExpense) || isset($single_property->unmapped->WaterSewerExpense) || isset($single_property->unmapped->TrashExpense) ):?>
		...
		<table class="bt-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="bt-listing__table__label">Number Of Separate Electric Meters</td>
					<td class="bt-listing__table__items"><span>[unmapped_NumberOfSeparateElectricMeters]</span></td>
				</tr>
				<?php endif; ?>	
				<?php if( isset($single_property->unmapped->NumberOfSeparateWaterMeters)): ?>
				<tr>
					<td class="bt-listing__table__label">Number Of Separate Water Meters</td>
					<td class="bt-listing__table__items"><span>[unmapped_NumberOfSeparateWaterMeters]</span></td>
				</tr>
				<?php endif; ?>	
				<?php if( isset($single_property->unmapped->NumberOfSeparateGasMeters)): ?>
				<tr>
					<td class="bt-listing__table__label">Number Of Separate Gas Meters</td>
					<td class="bt-listing__table__items"><span>[unmapped_NumberOfSeparateGasMeters]</span></td>
				</tr>
				<?php endif; ?>	
				<?php if( isset($single_property->unmapped->FuelExpense)): ?>
				<tr>
					<td class="bt-listing__table__label">Fuel Expense</td>
					<td class="bt-listing__table__items"><span>[unmapped_FuelExpense]</span></td>
				</tr>
				<?php endif; ?>	
				<?php if( isset($single_property->unmapped->ElectricExpense)): ?>
				<tr>
					<td class="bt-listing__table__label">Electric Expense</td>
					<td class="bt-listing__table__items"><span>[unmapped_ElectricExpense]</span></td>
				</tr>
				<?php endif; ?>	
				<?php if( isset($single_property->unmapped->WaterSewerExpense)): ?>
				<tr>
					<td class="bt-listing__table__label">Water Sewer Expense</td>
					<td class="bt-listing__table__items"><span>[unmapped_WaterSewerExpense]</span></td>
				</tr>
				<?php endif; ?>	
				<?php if( isset($single_property->unmapped->TrashExpense)): ?>
				<tr>
					<td class="bt-listing__table__label">Trash Expense</td>
					<td class="bt-listing__table__items"><span>[unmapped_TrashExpense]</span></td>
				</tr>
				<?php endif; ?>			
			</tbody>
		</table>
