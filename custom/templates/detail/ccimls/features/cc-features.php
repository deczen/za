	...
	<li class="cell">
		...
		<table class="bt-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="bt-listing__table__label">Complex Completed</td>
					<td class="bt-listing__table__items"><span>[complexcomplete]</span></td>
				</tr>
				<?php endif; ?>				
				<?php if( isset($single_property->condominiumname)): ?>
				<tr>
					<td class="bt-listing__table__label">Complex Name</td>
				...
				<tr>
					...
					<td class="bt-listing__table__items"><span>[unmapped_Condo Style]</span></td>
				</tr>
				<?php endif; ?>				
				<?php if( isset($single_property->condoassociation)): ?>
				<tr>
					<td class="bt-listing__table__label">Condo Type</td>
				...
				<tr>
					<td class="bt-listing__table__label">Management</td>
					<td class="bt-listing__table__items"><span>[management]</span></td>
				</tr>
				<?php endif; ?>	
				...
				<tr>
					<td class="bt-listing__table__label">Monthly Association Fee</td>
