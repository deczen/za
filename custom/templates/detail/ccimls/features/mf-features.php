	...
	<li class="cell">
		...
		<table class="zy-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="zy-listing__table__label">Separate Living Quarters</td>
					<td class="zy-listing__table__items"><span>[unmapped_Separate Living Qtrs]</span></td>
				</tr>
				<?php endif; ?>			
				<?php if( isset($single_property->unmapped->{'Sewer: Septic Tank'})): ?>
				<tr>
					<td class="zy-listing__table__label">Sewer Septic Tank</td>
					<td class="zy-listing__table__items"><span>[unmapped_Sewer: Septic Tank]</span></td>
				</tr>
				<?php endif; ?>			
				...
				<tr>
					...
					<td class="zy-listing__table__items"><span>[unmapped_Beach/Lake/Pond]</span></td>
				</tr>
				<?php endif; ?>	
				...
				<tr>
					...
					<td class="zy-listing__table__items"><span>[unmapped_Siding Description]</span></td>
				</tr>
				<?php endif; ?>	
				<?php if( isset($single_property->unmapped->{'Street Description'})): ?>
				<tr>
					<td class="zy-listing__table__label">Street Description</td>
					<td class="zy-listing__table__items"><span>[unmapped_Street Description]</span></td>
				</tr>
				<?php endif; ?>	
	...
	<li class="cell">
		...
		<table class="zy-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="zy-listing__table__label">Dock Description</td>
					<td class="zy-listing__table__items"><span>[unmapped_Dock Description]</span></td>
				</tr>
				<?php endif; ?>	
				...
				<tr>
					<td class="zy-listing__table__label">Garage Description </td>
				...
				<tr>
					...
					<td class="zy-listing__table__items"><span>[Waterview]</span></td>
				</tr>
				<?php endif; ?>	
	...
	<li class="cell">
		...
		<table class="zy-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="zy-listing__table__label">Basement Area Sq Ft</td>
					<td class="zy-listing__table__items"><span>[unmapped_Basement Area SqFt]</span></td>
				</tr>
				<?php endif; ?>					
				...
				<tr>
					<td class="zy-listing__table__label">Kitchen Dining Combo</td>
					<td class="zy-listing__table__items"><span>[unmapped_Kitchen/Dining Combo]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					...
					<td class="zy-listing__table__items"><span>[unmapped_Master Bedroom: Master Bedroom Level]</span></td>
				</tr>
				<?php endif; ?>
		...
		<h3 class="zy-listing__headline">Room Informations</h3>
		<table class="zy-listing__table">
			<tbody>
				<?php if( isset($single_property->unmapped->{'Unit 1 Info: Bedrooms'})): ?>
				<tr>
					<td class="zy-listing__table__label">Unit1 Bedrooms</td>
					<td class="zy-listing__table__items"><span>[unmapped_Unit 1 Info: Bedrooms]</span></td> <!-- not done -->
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Unit 1 Features'})): ?>
				<tr>
					<td class="zy-listing__table__label">Unit1 Features</td>
					<td class="zy-listing__table__items"><span>[unmapped_Unit 1 Features]</span></td> <!-- not done -->
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Unit 1 Info: Floor/Level'})): ?>
				<tr>
					<td class="zy-listing__table__label">Unit1 Floor Level</td>
					<td class="zy-listing__table__items"><span>[unmapped_Unit 1 Info: Floor/Level]</span></td> <!-- not done -->
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Unit 1 Floor Lvl/Des'})): ?>
				<tr>
					<td class="zy-listing__table__label">Unit1 Floor Level Description</td>
					<td class="zy-listing__table__items"><span>[unmapped_Unit 1 Floor Lvl/Des]</span></td> <!-- not done -->
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Unit 1 Info: Full Baths'})): ?>
				<tr>
					<td class="zy-listing__table__label">Unit1 Full Baths</td>
					<td class="zy-listing__table__items"><span>[unmapped_Unit 1 Info: Full Baths]</span></td> <!-- not done -->
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Unit 2 Info: Bedrooms'})): ?>
				<tr>
					<td class="zy-listing__table__label">Unit2 Bedrooms</td>
					<td class="zy-listing__table__items"><span>[unmapped_Unit 2 Info: Bedrooms]</span></td> <!-- not done -->
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Unit 2 Features'})): ?>
				<tr>
					<td class="zy-listing__table__label">Unit2 Features</td>
					<td class="zy-listing__table__items"><span>[unmapped_Unit 2 Features]</span></td> <!-- not done -->
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Unit 2 Floor Lvl/Des'})): ?>
				<tr>
					<td class="zy-listing__table__label">Unit2 Floor Level Description</td>
					<td class="zy-listing__table__items"><span>[unmapped_Unit 2 Floor Lvl/Des]</span></td> <!-- not done -->
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Unit 2 Info: Full Baths'})): ?>
				<tr>
					<td class="zy-listing__table__label">Unit2 Full Baths</td>
					<td class="zy-listing__table__items"><span>[unmapped_Unit 2 Info: Full Baths]</span></td> <!-- not done -->
				</tr>
				<?php endif; ?>
		...
		<table class="zy-listing__table">
			<tbody>
				...
				<tr>
					...
					<td class="zy-listing__table__items"><span>[totalassessedvalue]</span></td> <!-- not done -->
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Other Assessments'})): ?>
				<tr>
					<td class="zy-listing__table__label">Other Assessments</td>
					<td class="zy-listing__table__items"><span>[unmapped_Other Assessments]</span></td> <!-- not done -->
				</tr>
				<?php endif; ?>
			</tbody>
		</table>
