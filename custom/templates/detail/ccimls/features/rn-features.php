	...
	<li class="cell">
		...
		<table class="zy-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="zy-listing__table__label">First Month Required</td>
					<td class="zy-listing__table__items"><span>[unmapped_First Month Required]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Last Month Required</td>
					<td class="zy-listing__table__items"><span>[unmapped_Last Month Required]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Lease Purchase</td>
					<td class="zy-listing__table__items"><span>[unmapped_Lease Purchase]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Lease w/Option to Buy'}) ): ?>
				<tr>
					<td class="zy-listing__table__label">Lease With Option To Buy</td>
					<td class="zy-listing__table__items"><span>[unmapped_Lease w/Option to Buy]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Maximum Occupancy</td>
					<td class="zy-listing__table__items"><span>[nolots]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Rate</td>
					<td class="zy-listing__table__items"><span>[unmapped_Rate]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Rental Type'}) ): ?>
				<tr>
					<td class="zy-listing__table__label">Rental Type</td>
					<td class="zy-listing__table__items"><span>[unmapped_Rental Type]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Secuirty Deposit Required'}) ): ?>
				<tr>
					<td class="zy-listing__table__label">Secuirty Deposit Required</td>
					<td class="zy-listing__table__items"><span>[unmapped_Secuirty Deposit Required]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Smoking Allowed</td>
					<td class="zy-listing__table__items"><span>[smokingallowed]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Utilities Included</td>
				...
				<tr>
					<td class="zy-listing__table__label">Furnished</td>
					<td class="zy-listing__table__items"><span>[furnished]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->basement) ): ?>
				<tr>
					<td class="zy-listing__table__label">Includes Basement</td>
					<td class="zy-listing__table__items"><span>[basement]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Master Bath'}) ): ?>
				<tr>
					<td class="zy-listing__table__label">Master Bath</td>
					<td class="zy-listing__table__items"><span>[unmapped_Master Bath]</span></td>
				</tr>
				<?php endif; ?>
	...
	<li class="cell">
		...
		<table class="zy-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="zy-listing__table__label">Water View Description</td>
	...
	<li class="cell">
		...
		<table class="zy-listing__table">
			<tbody>
				...
				<tr>
					<td class="zy-listing__table__label">Additional Cleaning Fee</td>
					<td class="zy-listing__table__items"><span>[unmapped_Addnl Cleaning Fee]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Addnl Laundry Fee'})): ?>
				<tr>
					<td class="zy-listing__table__label">Additional Laundry Fee</td>
					<td class="zy-listing__table__items"><span>[unmapped_Addnl Laundry Fee]</span></td>
				</tr>
				<?php endif; ?>
