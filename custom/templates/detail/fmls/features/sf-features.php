	...
	<li class="cell">
		...
		<table class="bt-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="bt-listing__table__label">Stories</td>
					<td class="bt-listing__table__items"><span>[unmapped_Stories]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					...
					<td class="bt-listing__table__items"><span>[unmapped_Construction Status]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Fireplace Type</td>
					<td class="bt-listing__table__items"><span>[unmapped_Fireplace Type]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->GreenEnergyGeneration)): ?>
				<tr>
					<td class="bt-listing__table__label">Green Energy Generation</td>
					<td class="bt-listing__table__items"><span>[unmapped_GreenEnergyGeneration]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Window Features</td>
					<td class="bt-listing__table__items"><span>[unmapped_WindowFeatures]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Road Frontage Type</td>
					<td class="bt-listing__table__items"><span>[unmapped_RoadFrontageType]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->HorseAmenities)): ?>
				<tr>
					<td class="bt-listing__table__label">Horse Amenities</td>
					<td class="bt-listing__table__items"><span>[unmapped_HorseAmenities]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Other Structures</td>
					<td class="bt-listing__table__items"><span>[unmapped_OtherStructures]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Water Body Name</td>
					<td class="bt-listing__table__items"><span>[waterbodyname]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->WaterfrontageLength)): ?>
				<tr>
					<td class="bt-listing__table__label">Water Front Age Length</td>
					<td class="bt-listing__table__items"><span>[unmapped_WaterfrontageLength]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Property Attached Y/N</td>
					<td class="bt-listing__table__items"><span>[unmapped_PropertyAttachedYN]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->LandLeaseYN)): ?>
				<tr>
					<td class="bt-listing__table__label">Land Lease Y/N</td>
					<td class="bt-listing__table__items"><span>[unmapped_LandLeaseYN]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->CommonWalls)): ?>
				<tr>
					<td class="bt-listing__table__label">Common Walls</td>
					<td class="bt-listing__table__items"><span>[unmapped_CommonWalls]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Water OnLand</td>
					<td class="bt-listing__table__items"><span>[unmapped_WaterOnLand]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					...
					<td class="bt-listing__table__items"><span>[unmapped_Lot Size]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					...
					<td class="bt-listing__table__items"><span>[adultcommunity]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Laundry Type</td>
					<td class="bt-listing__table__items"><span>[unmapped_Laundry Type]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->Equipment)): ?>
				<tr>
					<td class="bt-listing__table__label">Equipment</td>
					<td class="bt-listing__table__items"><span>[unmapped_Equipment]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Financing Type'})): ?>
				<tr>
					<td class="bt-listing__table__label">Financing Type</td>
					<td class="bt-listing__table__items"><span>[unmapped_Financing Type]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Possible Financing'})): ?>
				<tr>
					<td class="bt-listing__table__label">Possible Financing</td>
					<td class="bt-listing__table__items"><span>[unmapped_Possible Financing]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Above Grade Finished'})): ?>
				<tr>
					<td class="bt-listing__table__label">Above Grade Finished</td>
					<td class="bt-listing__table__items"><span>[unmapped_Above Grade Finished]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Below Grade Unfinished'})): ?>
				<tr>
					<td class="bt-listing__table__label">Below Grade Unfinished</td>
					<td class="bt-listing__table__items"><span>[unmapped_Below Grade Unfinished]</span></td>
				</tr>
				<?php endif; ?>
	...
	<?php if( isset($single_property->reqdownassociation) || isset($single_property->feeinterval) || isset($single_property->hoafee) || isset($single_property->assocsecurity) || isset($single_property->unmapped->{'Fees Include'}) || isset($single_property->asscfeeincludes) ):?>
		...
		<table class="bt-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="bt-listing__table__label">Assoc Security</td>
					<td class="bt-listing__table__items"><span>[assocsecurity]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Fees Include'})): ?>
				<tr>
					<td class="bt-listing__table__label">Fees Include</td>
					<td class="bt-listing__table__items"><span>[unmapped_Fees Include]</span></td>
				</tr>
				<?php endif; ?>	
				<?php if( isset($single_property->asscfeeincludes)): ?>
				<tr>
					<td class="bt-listing__table__label">Assc Fee Includes</td>
					<td class="bt-listing__table__items"><span>[asscfeeincludes Include]</span></td>
				</tr>
				<?php endif; ?>		
			</tbody>
		</table>
	...
	<?php if( isset($single_property->cooling) || isset($single_property->unmapped->{'Cooling Source'}) || isset($single_property->heating) || isset($single_property->unmapped->{'Heating Source'}) || isset($single_property->utilities) || isset($single_property->sewer) || isset($single_property->water) || isset($single_property->sewerandwater) || isset($single_property->energyfeatures) ):?>
		...
		<table class="bt-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="bt-listing__table__label">Cooling Source</td>
					<td class="bt-listing__table__items"><span>[unmapped_Cooling Source]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Heating Source</td>
					<td class="bt-listing__table__items"><span>[unmapped_Heating Source]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Sewer and Water</td>
					<td class="bt-listing__table__items"><span>[sewerandwater]</span></td>
				</tr>
				<?php endif; ?>	
	...
	<li class="cell">
		...
		<table class="bt-listing__table">
			<tbody>
				...
				<tr>
					<td class="bt-listing__table__label">Carport Garage Total</td>
					<td class="bt-listing__table__items"><span>[unmapped_CarportGarageTotal]</span></td>
				</tr>
				<?php endif; ?>
		...
		<table class="bt-listing__table">
			<tbody>
				...
				<tr>
					<td class="bt-listing__table__label">Tax ID</td>
					<td class="bt-listing__table__items"><span>[unmapped_Tax ID]</span></td>
				</tr>
				<?php endif; ?>
		...
		<table class="bt-listing__table">
			<tbody>
				...
				<tr>
					...
					<td class="bt-listing__table__items"><span>[unmapped_RoomType]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->UpperLevelBedrooms)): ?>
				<tr>
					<td class="bt-listing__table__label">Upper Level Bedrooms</td>
					<td class="bt-listing__table__items"><span>[unmapped_UpperLevelBedrooms]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->LowerLevelBedrooms)): ?>
				<tr>
					<td class="bt-listing__table__label">Lower Level Bedrooms</td>
					<td class="bt-listing__table__items"><span>[unmapped_LowerLevelBedrooms]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->UpperLevelHalfBathrooms)): ?>
				<tr>
					<td class="bt-listing__table__label">Upper Level Half Bathrooms</td>
					<td class="bt-listing__table__items"><span>[unmapped_UpperLevelHalfBathrooms]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'BAF Main'})): ?>
				<tr>
					<td class="bt-listing__table__label">BAF Main</td>
					<td class="bt-listing__table__items"><span>[unmapped_BAF Main]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'BAF Upper'})): ?>
				<tr>
					<td class="bt-listing__table__label">BAF Upper</td>
					<td class="bt-listing__table__items"><span>[unmapped_BAF Upper]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'BAF Lower'})): ?>
				<tr>
					<td class="bt-listing__table__label">BAF Lower</td>
					<td class="bt-listing__table__items"><span>[unmapped_BAF Lower]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'BR Main'})): ?>
				<tr>
					<td class="bt-listing__table__label">BR Main</td>
					<td class="bt-listing__table__items"><span>[unmapped_BR Main]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'BR Upper'})): ?>
				<tr>
					<td class="bt-listing__table__label">BR Upper</td>
					<td class="bt-listing__table__items"><span>[unmapped_BR Upper]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'BR Lower'})): ?>
				<tr>
					<td class="bt-listing__table__label">BR Lower</td>
					<td class="bt-listing__table__items"><span>[unmapped_BR Lower]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'BAH Main'})): ?>
				<tr>
					<td class="bt-listing__table__label">BAH Main</td>
					<td class="bt-listing__table__items"><span>[unmapped_BAH Main]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'BAH Upper'})): ?>
				<tr>
					<td class="bt-listing__table__label">BAH Upper</td>
					<td class="bt-listing__table__items"><span>[unmapped_BAH Upper]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'BAH Lower'})): ?>
				<tr>
					<td class="bt-listing__table__label">BAH Lower</td>
					<td class="bt-listing__table__items"><span>[unmapped_BAH Lower]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Masterbath</td>
					<td class="bt-listing__table__items"><span>[masterbath]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->bed2DSCRP)): ?>
				<tr>
					<td class="bt-listing__table__label">Bedrooms Description</td>
					<td class="bt-listing__table__items"><span>[unmapped_bed2DSCRP]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->dinDSCRP)): ?>
				<tr>
					<td class="bt-listing__table__label">Dinning room Description</td>
					<td class="bt-listing__table__items"><span>[unmapped_dinDSCRP]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->kitDSCRP)): ?>
				<tr>
					<td class="bt-listing__table__label">Kitchen Description</td>
					<td class="bt-listing__table__items"><span>[unmapped_kitDSCRP]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Kitchen/Breakfas'})): ?>
				<tr>
					<td class="bt-listing__table__label">Kitchen/Breakfas</td>
					<td class="bt-listing__table__items"><span>[unmapped_Kitchen/Breakfas]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Kitchen Equipment'})): ?>
				<tr>
					<td class="bt-listing__table__label">Kitchen Equipment</td>
					<td class="bt-listing__table__items"><span>[unmapped_Kitchen Equipment]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Laundry Location'})): ?>
				<tr>
					<td class="bt-listing__table__label">Laundry Location</td>
					<td class="bt-listing__table__items"><span>[unmapped_Laundry Location]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Fireplace Location</td>
					<td class="bt-listing__table__items"><span>[unmapped_Fireplace Location]</span></td>
				</tr>
				<?php endif; ?>
			</tbody>
		</table>
				...
				<?php foreach($roomLevels as $rkey => $roomLevel): ?>
					<table class="bt-listing__table">
						<tbody>
							...
							<tr>
								<td class="bt-listing__table__label">Floor</td>
								<td class="bt-listing__table__items"><span>[roomLevels_<?php echo $rkey; ?>_floor]</span></td>
							</tr>
							<?php endif; ?>
						</tbody>
					</table>
