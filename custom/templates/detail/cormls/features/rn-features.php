	...
	<li class="cell">
		...
		<table class="bt-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="bt-listing__table__label">Year Built</td>
					<td class="bt-listing__table__items"><span>[yearbuilt]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->rentalterms)): ?>
				<tr>
					<td class="bt-listing__table__label">Lease Term</td>
					<td class="bt-listing__table__items"><span>[rentalterms]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Application Fee Reqd'})): ?>
				<tr>
					<td class="bt-listing__table__label">Application Fee</td>
					<td class="bt-listing__table__items"><span>[unmapped_Application Fee Reqd]</span></td>
				</tr>
				<?php endif; ?>
				...
				<?php if( isset($single_property->basementfeature)): ?>
				<tr>
					<td class="bt-listing__table__label">Basement Foundation</td>
					<td class="bt-listing__table__items"><span>[basementfeature]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Amount</td>
					<td class="bt-listing__table__items"><span>[unmapped_Amount]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Mult Parcels Sch Dis</td>
					<td class="bt-listing__table__items"><span>[unmapped_Mult Parcels/Sch Dis]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->construction)): ?>
				<tr>
					<td class="bt-listing__table__label">New Construction</td>
					<td class="bt-listing__table__items"><span>[construction]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{"Pet Info: Pet(s) Deposit Req'd"})): ?>
				<tr>
					<td class="bt-listing__table__label">Pet Info Pets Deposit Reqd</td>
					<td class="bt-listing__table__items"><span>[unmapped_Pet Info: Pet(s) Deposit Req'd]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Pet Info: Weight Limit'})): ?>
				<tr>
					<td class="bt-listing__table__label">Pet Info Weight Limit</td>
					<td class="bt-listing__table__items"><span>[unmapped_Pet Info: Weight Limit]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Pet Type'})): ?>
				<tr>
					<td class="bt-listing__table__label">Pet Type</td>
					<td class="bt-listing__table__items"><span>[unmapped_Pet Type]</span></td>
				</tr>
				<?php endif; ?>
				...
				<?php if( isset($single_property->rentalterms)): ?>
				<tr>
					<td class="bt-listing__table__label">Rental Term</td>
					<td class="bt-listing__table__items"><span>[rentalterms]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Section 8'})): ?>
				<tr>
					<td class="bt-listing__table__label">Section8</td>
					<td class="bt-listing__table__items"><span>[unmapped_Section 8]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="bt-listing__table__label">Smoking Permitted</td>
					<td class="bt-listing__table__items"><span>[smokingallowed]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'ATFLS Source'})): ?>
				<tr>
					<td class="bt-listing__table__label">Source</td>
					<td class="bt-listing__table__items"><span>[unmapped_ATFLS Source]</span></td>
				</tr>
				<?php endif; ?>
	...
	<li class="cell">
		...
		<table class="bt-listing__table">
			<tbody>
				...
				<tr>
					<td class="bt-listing__table__label">Sq Ft Tax Record </td>
