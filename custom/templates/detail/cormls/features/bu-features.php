	...
	<li class="cell">
		...
		<table class="zy-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="zy-listing__table__label">Annual Base Rent</td>
					<td class="zy-listing__table__items"><span>[unmapped_AnnualBaseRent]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->EffectiveIncome)): ?>
				<tr>
					<td class="zy-listing__table__label">Effective Income</td>
					<td class="zy-listing__table__items"><span>[unmapped_EffectiveIncome]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->EffectiveIncomePotential)): ?>
				<tr>
					<td class="zy-listing__table__label">Effective Income Potential</td>
					<td class="zy-listing__table__items"><span>[unmapped_EffectiveIncomePotential]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->ExpenseNonReimbursable)): ?>
				<tr>
					<td class="zy-listing__table__label">Expense Non Reimbursable</td>
					<td class="zy-listing__table__items"><span>[unmapped_ExpenseNonReimbursable]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->ExpenseNonReimbursementPotential)): ?>
				<tr>
					<td class="zy-listing__table__label">Expense Non Reimbursement Potent</td>
					<td class="zy-listing__table__items"><span>[unmapped_ExpenseNonReimbursementPotential]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->ExpenseReimbursable)): ?>
				<tr>
					<td class="zy-listing__table__label">Expense Reimbursable</td>
					<td class="zy-listing__table__items"><span>[unmapped_ExpenseReimbursable]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->ExpenseReimbursablePotential)): ?>
				<tr>
					<td class="zy-listing__table__label">Expense Reimbursable Potential</td>
					<td class="zy-listing__table__items"><span>[unmapped_ExpenseReimbursablePotential]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->GrossIncomePotential)): ?>
				<tr>
					<td class="zy-listing__table__label">Gross Income Potential</td>
					<td class="zy-listing__table__items"><span>[unmapped_GrossIncomePotential]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->NetOperatingIncomePotential)): ?>
				<tr>
					<td class="zy-listing__table__label">Net Operating Income Potential</td>
					<td class="zy-listing__table__items"><span>[unmapped_NetOperatingIncomePotential]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->SubLeaseYN)): ?>
				<tr>
					<td class="zy-listing__table__label">Sub Lease YN</td>
					<td class="zy-listing__table__items"><span>[unmapped_SubLeaseYN]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->TaxesRealEstate)): ?>
				<tr>
					<td class="zy-listing__table__label">Taxes Real Estate</td>
					<td class="zy-listing__table__items"><span>[unmapped_TaxesRealEstate]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->VacancyPCT)): ?>
				<tr>
					<td class="zy-listing__table__label">Vacancy PCT</td>
					<td class="zy-listing__table__items"><span>[unmapped_VacancyPCT]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->VacancyPCTPotential)): ?>
				<tr>
					<td class="zy-listing__table__label">Vacancy PCTPotential</td>
					<td class="zy-listing__table__items"><span>[unmapped_VacancyPCTPotential]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Auction Deposit Required</td>
					<td class="zy-listing__table__items"><span>[unmapped_Auction Info: Deposit Required]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Bus Financial Info Annual Expenses</td>
					<td class="zy-listing__table__items"><span>[unmapped_Bus Financial Info: Annual Expenses]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Bus Financial Info: Cost of Goods'})): ?>
				<tr>
					<td class="zy-listing__table__label">Bus Financial Info Costof Goods</td>
					<td class="zy-listing__table__items"><span>[unmapped_Bus Financial Info: Cost of Goods]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Bus Financial Info: From'})): ?>
				<tr>
					<td class="zy-listing__table__label">Bus Financial Info From</td>
					<td class="zy-listing__table__items"><span>[unmapped_Bus Financial Info: From]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Bus Financial Info: Gross Profit'})): ?>
				<tr>
					<td class="zy-listing__table__label">Bus Financial Info Gross Profit</td>
					<td class="zy-listing__table__items"><span>[unmapped_Bus Financial Info: Gross Profit]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Bus Financial Info: Gross Sales'})): ?>
				<tr>
					<td class="zy-listing__table__label">Bus Financial Info Gross Sales</td>
					<td class="zy-listing__table__items"><span>[unmapped_Bus Financial Info: Gross Sales]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Bus Financial Info: Net Before Taxes'})): ?>
				<tr>
					<td class="zy-listing__table__label">Bus Financial Info Net Before Taxes</td>
					<td class="zy-listing__table__items"><span>[unmapped_Bus Financial Info: Net Before Taxes]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Bus Financial Info: Through'})): ?>
				<tr>
					<td class="zy-listing__table__label">Bus Financial Info Through</td>
					<td class="zy-listing__table__items"><span>[unmapped_Bus Financial Info: Through]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Business Description'})): ?>
				<tr>
					<td class="zy-listing__table__label">Business Description</td>
					<td class="zy-listing__table__items"><span>[unmapped_Business Description]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Employees </td>
					<td class="zy-listing__table__items"><span>[unmapped_# of Employees]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Hours Open'})): ?>
				<tr>
					<td class="zy-listing__table__label">Hours Open</td>
					<td class="zy-listing__table__items"><span>[unmapped_Hours Open]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Landlord Pays'})): ?>
				<tr>
					<td class="zy-listing__table__label">Landlord Pays</td>
					<td class="zy-listing__table__items"><span>[unmapped_Landlord Pays]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->Ownership)): ?>
				<tr>
					<td class="zy-listing__table__label">Ownership</td>
					<td class="zy-listing__table__items"><span>[unmapped_Ownership]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->reasonforsell)): ?>
				<tr>
					<td class="zy-listing__table__label">Reason For Sale</td>
					<td class="zy-listing__table__items"><span>[reasonforsell]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Renewals Available'})): ?>
				<tr>
					<td class="zy-listing__table__label">Renewals Available</td>
					<td class="zy-listing__table__items"><span>[unmapped_Renewals Available]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Sales Includes'})): ?>
				<tr>
					<td class="zy-listing__table__label">Sales Includes</td>
					<td class="zy-listing__table__items"><span>[unmapped_Sales Includes]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->secdeposit)): ?>
				<tr>
					<td class="zy-listing__table__label">Security Deposit</td>
					<td class="zy-listing__table__items"><span>[secdeposit]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Seller/Business Name'})): ?>
				<tr>
					<td class="zy-listing__table__label">Seller Business Name</td>
					<td class="zy-listing__table__items"><span>[unmapped_Seller/Business Name]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Tenant Pays</td>
					<td class="zy-listing__table__items"><span>[tenantexpanses]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Time SellerWillTrain'})): ?>
				<tr>
					<td class="zy-listing__table__label">Time Seller Will Train</td>
					<td class="zy-listing__table__items"><span>[unmapped_Time SellerWillTrain]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Years In Business</td>
					<td class="zy-listing__table__items"><span>[unmapped_Years in Business]</span></td>
				</tr>
				<?php endif; ?>
			</tbody>
		</table>
	...
	<li class="cell">
		...
		<table class="zy-listing__table">
			...
			<tbody>
				<?php if( isset($single_property->bldgsqfeet)): ?>
				<tr>
					<td class="zy-listing__table__label">Bldg Sq Ft</td>
