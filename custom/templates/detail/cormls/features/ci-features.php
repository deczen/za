	...
	<li class="cell">
		...
		<table class="zy-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="zy-listing__table__label">Assessment </td>
				...
				<tr>
					<td class="zy-listing__table__label">Dist To Interchange</td>
					<td class="zy-listing__table__items"><span>[unmapped_Dist To Interchange]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Expenses Paid By Landlord</td>
					<td class="zy-listing__table__items"><span>[unmapped_Expenses Paid by L: Curr Yr Est $/SF LL]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->exchange)): ?>
				<tr>
					<td class="zy-listing__table__label">For Exchange</td>
					<td class="zy-listing__table__items"><span>[exchange]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'For Lease'})): ?>
				<tr>
					<td class="zy-listing__table__label">For Lease</td>
					<td class="zy-listing__table__items"><span>[unmapped_For Lease]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Mult Use</td>
					<td class="zy-listing__table__items"><span>[unmapped_Mult Use]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Near Interchange'})): ?>
				<tr>
					<td class="zy-listing__table__label">Near Interchange</td>
					<td class="zy-listing__table__items"><span>[unmapped_Near Interchange]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->specialfinancing)): ?>
				<tr>
					<td class="zy-listing__table__label">New Financing</td>
				...
				<tr>
					<td class="zy-listing__table__label">Previous Use</td>
					<td class="zy-listing__table__items"><span>[unmapped_Previous Use]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Suite1 Date Available</td>
					<td class="zy-listing__table__items"><span>[unmapped_Suite Info 1: Date Available]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Use Code</td>
					<td class="zy-listing__table__items"><span>[unmapped_Use Code]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Year Remodeled'})): ?>
				<tr>
					<td class="zy-listing__table__label">Year Remodeled</td>
					<td class="zy-listing__table__items"><span>[unmapped_Year Remodeled]</span></td>
				</tr>
				<?php endif; ?>
	...
	<li class="cell">
		...
		<table class="zy-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="zy-listing__table__label">Dock Size</td>
					<td class="zy-listing__table__items"><span>[unmapped_Dock Size]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->noofloadingdocks)): ?>
				<tr>
					<td class="zy-listing__table__label">Docks</td>
				...
				<tr>
					<td class="zy-listing__table__label">Total Parking</td>
		...
		<table class="zy-listing__table">
			<tbody>
				...
				<tr>
					<td class="zy-listing__table__label">Tax Incentive</td>
					<td class="zy-listing__table__items"><span>[unmapped_Tax Incentive]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Taxes Yearly</td>
		...
		<?php if( isset($single_property->bldgsqfeet) || isset($single_property->unmapped->{'# Floors AboveGround'}) || isset($single_property->unmapped->{'Heat Fuel'}) || isset($single_property->heating) || isset($single_property->unmapped->{'Max Cont Sqft Avail'}) || isset($single_property->unmapped->{'Minimum Sqft Avail'}) || isset($single_property->sprinklers) || isset($single_property->unmapped->{'Suite Info 1: SQ FT'}) ):?>
			...
			<table class="zy-listing__table">
				<tbody>
					...
					<tr>
						<td class="zy-listing__table__label">Floors Above Ground</td>
						<td class="zy-listing__table__items"><span>[unmapped_# Floors AboveGround]</span></td>
					</tr>
					<?php endif; ?>
					...
					<tr>
						<td class="zy-listing__table__label">Max Cont Sqft Avail</td>
						<td class="zy-listing__table__items"><span>[unmapped_Max Cont Sqft Avail]</span></td>
					</tr>
					<?php endif; ?>
					<?php if( isset($single_property->unmapped->{'Minimum Sqft Avail'})): ?>
					<tr>
						<td class="zy-listing__table__label">Minimum Sq Ft Available</td>
						<td class="zy-listing__table__items"><span>[unmapped_Minimum Sqft Avail]</span></td>
					</tr>
					<?php endif; ?>
					<?php if( isset($single_property->sprinklers)): ?>
					<tr>
						<td class="zy-listing__table__label">Sprinkler</td>
						<td class="zy-listing__table__items"><span>[sprinklers]</span></td>
					</tr>
					<?php endif; ?>
					<?php if( isset($single_property->unmapped->{'Suite Info 1: SQ FT'})): ?>
					<tr>
						<td class="zy-listing__table__label">Suite1 Sq Ft</td>
						<td class="zy-listing__table__items"><span>[unmapped_Suite Info 1: SQ FT]</span></td>
					</tr>
					<?php endif; ?>
				</tbody>
			</table>
