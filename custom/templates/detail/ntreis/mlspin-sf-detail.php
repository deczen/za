						...
						<div class="mb-15 p-0 bt-panel uk-panel uk-panel-box">
							...
							<div class="bt-panel__stack__sub">
								<ul class="bt-listing__feature-grid" style="margin-bottom:0">
									...
									<li class="sqft ">
										<div class="attr-num"> [unmapped_SqFtTotal] </div>
										<div class="uk-text-small uk-text-truncate">SQFT</div>
									</li>
									<li class="acres">
										<div class="attr-num bt-listing__acreage-text">[unmapped_LotSizeAreaSQFT]</div>
										<div class="uk-text-small uk-text-truncate">Lot Size SQFT</div>
									</li>
