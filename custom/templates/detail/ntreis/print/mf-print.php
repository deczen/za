		...
		<table class="zy-print__meta-blocks">
		   <tr>
			...
			<?php if(isset($single_property->unmapped->BathsThreeQuarter)): ?>
			  <td>
				 <div class="zy-print__meta-val">[unmapped_BathsThreeQuarter]</div>
			...
			<?php endif; ?>
			<?php if(isset($single_property->unmapped->SqFtTotal)): ?>
			  <td>
				 <div class="zy-print__meta-val">[unmapped_SqFtTotal]</div>
				 <div class="zy-print__meta-label">SQFT</div>
			  </td>
			<?php endif; ?>
			<?php if(isset($single_property->unmapped->LotSizeAreaSQFT)): ?>
			  <td>
				 <div class="zy-print__meta-val">[unmapped_LotSizeAreaSQFT]</div>
				 <div class="zy-print__meta-label">Lot Size SQFT</div>
			  </td>
			<?php endif; ?>
			  <?php /* <td>
