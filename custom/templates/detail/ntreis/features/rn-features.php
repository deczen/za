	...
	<li class="cell">
		...
		<table class="zy-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="zy-listing__table__label">Building Use</td>
					<td class="zy-listing__table__items"><span>[unmapped_BuildingUse]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Rent fee Includes</td>
					<td class="zy-listing__table__items"><span>[rentfeeincludes]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Development</td>
					<td class="zy-listing__table__items"><span>[unmapped_Development]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->ProposedUse)): ?>
				<tr>
					<td class="zy-listing__table__label">Proposed Use</td>
					<td class="zy-listing__table__items"><span>[unmapped_ProposedUse]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Number Of Dining Areas</td>
					<td class="zy-listing__table__items"><span>[unmapped_NumberOfDiningAreas]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->SecuritySystemYN)): ?>
				<tr>
					<td class="zy-listing__table__label">Security System</td>
					<td class="zy-listing__table__items"><span>[unmapped_SecuritySystemYN]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Financing Proposed</td>
					<td class="zy-listing__table__items"><span>[unmapped_FinancingProposed]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->TotalAnnualExpensesInclude)): ?>
				<tr>
					<td class="zy-listing__table__label">Total Annual Expenses Include</td>
					<td class="zy-listing__table__items"><span>[unmapped_TotalAnnualExpensesInclude]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->IncomeExpenseSource)): ?>
				<tr>
					<td class="zy-listing__table__label">Income Expense Source</td>
					<td class="zy-listing__table__items"><span>[unmapped_IncomeExpenseSource]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->CommercialFeatures)): ?>
				<tr>
					<td class="zy-listing__table__label">Commercial Features</td>
					<td class="zy-listing__table__items"><span>[unmapped_CommercialFeatures]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Laundry Level</td>
				...
				<tr>
					...
					<td class="zy-listing__table__items"><span>[unmapped_CeilingHeight]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Road Frontage Distance</td>
					<td class="zy-listing__table__items"><span>[unmapped_RoadFrontageDistance]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Planned Development</td>
					<td class="zy-listing__table__items"><span>[unmapped_PlannedDevelopment]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->MoniesRequired)): ?>
				<tr>
					<td class="zy-listing__table__label">Monies Required</td>
					<td class="zy-listing__table__items"><span>[unmapped_MoniesRequired]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->LeaseConditions)): ?>
				<tr>
					<td class="zy-listing__table__label">Lease Conditions</td>
					<td class="zy-listing__table__items"><span>[unmapped_LeaseConditions]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->AppliancesYN)): ?>
				<tr>
					<td class="zy-listing__table__label">Appliances</td>
					<td class="zy-listing__table__items"><span>[unmapped_AppliancesYN]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->PermitInternetYN)): ?>
				<tr>
					<td class="zy-listing__table__label">Permit Internet</td>
					<td class="zy-listing__table__items"><span>[unmapped_PermitInternetYN]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->FencedYardYN)): ?>
				<tr>
					<td class="zy-listing__table__label">Fenced Yard</td>
					<td class="zy-listing__table__items"><span>[unmapped_FencedYardYN]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->CompensationPaid)): ?>
				<tr>
					<td class="zy-listing__table__label">Compensation Paid</td>
					<td class="zy-listing__table__items"><span>[unmapped_CompensationPaid]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Lease type</td>
					<td class="zy-listing__table__items"><span>[leasetype]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Insurance Expense</td>
					<td class="zy-listing__table__items"><span>[unmapped_InsuranceExpense]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->UnitCount)): ?>
				<tr>
					<td class="zy-listing__table__label">Unit Count</td>
					<td class="zy-listing__table__items"><span>[unmapped_UnitCount]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->bldgsqfeet)): ?>
				<tr>
					<td class="zy-listing__table__label">Bldgsqfeet</td>
				...
				<tr>
					...
					<td class="zy-listing__table__items"><span>[unmapped_PoolYN]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<td class="zy-listing__table__label">Restrictions</td>
					<td class="zy-listing__table__items"><span>[restrictions]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->easements)): ?>
				<tr>
					<td class="zy-listing__table__label">Easements</td>
					<td class="zy-listing__table__items"><span>[easements]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->CropRetireProgramYN)): ?>
				<tr>
					<td class="zy-listing__table__label">Crop Retire Program</td>
					<td class="zy-listing__table__items"><span>[unmapped_CropRetireProgramYN]</span></td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					...
					<td class="zy-listing__table__items"><span>[firmrmk1]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->ZoningCommercial)): ?>
				<tr>
					<td class="zy-listing__table__label">Zoning Commercial</td>
					<td class="zy-listing__table__items"><span>[unmapped_ZoningCommercial]</span></td>
				</tr>
				<?php endif; ?>
	...
	<?php if( isset($single_property->unmapped->AssociationType) || isset($single_property->hoafee) || isset($single_property->asscfeeincludes) || isset($single_property->feeinterval) ):?>
		...
		<table class="zy-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="zy-listing__table__label">Association Type</td>
					<td class="zy-listing__table__items"><span>[unmapped_AssociationType]</span></td>
				</tr>
				<?php endif; ?>
	...
	<li class="cell">
		...
		<table class="zy-listing__table">
			<tbody>
				...
				<tr>
					<td class="zy-listing__table__label">Parking Spaces Covered Total</td>
					<td class="zy-listing__table__items"><span>[unmapped_ParkingSpacesCoveredTotal]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->GarageLength) && isset($single_property->unmapped->GarageWidth)): ?>
				<tr>
					<td class="zy-listing__table__label">Garage Size</td>
					<td class="zy-listing__table__items"><span>[unmapped_GarageLength] X [unmapped_GarageWidth]</span></td>
				</tr>
				<?php endif; ?>
