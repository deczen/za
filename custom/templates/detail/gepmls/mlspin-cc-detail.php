						...
						<div class="mb-15 p-0 bt-panel uk-panel uk-panel-box">
							...
							<div class="bt-panel__stack__sub">
								<ul class="bt-listing__feature-grid" style="margin-bottom:0">
									...
									<li class="baths">
										<div class="attr-num">[no34BATHS]</div>
						...
						<li class="cell">
							...
							<table class="bt-listing__table">
								<tbody>
									...
									<tr>
										<td class="bt-listing__table__label">Metering</td>
										<td class="bt-listing__table__items"><span>[unmapped_Metering]</span></td>
									</tr>
									<?php endif; ?>				
								</tbody>
							</table>
							...
							<table class="bt-listing__table">
								...
								<tbody>
									...
									<tr>
										<td class="bt-listing__table__label">HOA Required?</td>
										<td class="bt-listing__table__items"><span>[unmapped_HOA Required?]</span></td>
									</tr>
									<?php endif; ?>	
									...
									<tr>
										<td class="bt-listing__table__label">HOA Fees Y/N</td>
										<td class="bt-listing__table__items"><span>[unmapped_HOA Fees Y/N]</span></td>
									</tr>
									<?php endif; ?>	
									<?php if( isset($single_property->unmapped->{"HOA Frequency"})): ?>
									<tr>
										<td class="bt-listing__table__label">HOA Frequency</td>
										<td class="bt-listing__table__items"><span>[unmapped_HOA Frequency]</span></td>
									</tr>
									<?php endif; ?>		
									<?php if( isset($single_property->unmapped->{"HOA Dues"})): ?>
									<tr>
										<td class="bt-listing__table__label">HOA Dues</td>
										<td class="bt-listing__table__items"><span>[unmapped_HOA Dues]</span></td>
									</tr>
									<?php endif; ?>	
