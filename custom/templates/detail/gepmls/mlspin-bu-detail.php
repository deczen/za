						...
						<div class="mb-15 p-0 bt-panel uk-panel uk-panel-box">
							...
							<div class="bt-panel__stack__sub">
								<div class="m-0 bt-listing-table bt-listing__table-break">
									...
									<div class="grid">
										<div class="cell cell-xs-3 uk-text-bold">Location:</div>
										<div class="cell uk-text-right">[location]</div>
									</div>
	...
	<div class="bt-print-view js-print-view">
	  <div class="bt-print__wrap">
		 <div class="bt-print__left">
			...
			<?php endif; ?>
			<div class="bt-print__block">
			   <h6 class="bt-print__header">Property Details</h6>
			   <p>
				  <?php if(isset($single_property->basement)): ?>
			...
			<div class="bt-print__block">
			   <h6 class="bt-print__header">Business Information</h6>
			   <p>
				  <?php if(isset($single_property->businesshrs)): ?>
				  ...
				  <?php endif; ?>
				  <?php if(isset($single_property->equiplistavail)): ?>
				  <strong>Equipment List Available</strong>
				  [equiplistavail]
				  <?php endif; ?>
				  <?php if(isset($single_property->form)): ?>
				  <strong>Form</strong>
				  ...
				  <?php endif; ?>
				  <?php if(isset($single_property->inventoryavail)): ?>
				  <strong>Inventory Included</strong>
				  [inventoryavail]
				  <?php endif; ?>
				  
				  <?php if(isset($single_property->realestateincld)): ?>
				  <strong>Real Estate Included</strong>
				  [realestateincld]
				  <?php endif; ?>
				  <?php if(isset($single_property->speciallicenses)): ?>
				  <strong>Special Licenses</strong>
				  [speciallicenses]
				  <?php endif; ?>
				  <?php if(isset($single_property->tenantexpanses)): ?>
				  <strong>Tenant Expenses</strong>
				  [tenantexpanses]
				  <?php endif; ?>
				  <?php if(isset($single_property->yearbuilt)): ?>
