<div class="bt-print__wrap">
	<div class="bt-print__header_top">
	 ...
	 <div class="bt-print__left">
		...
		<?php endif; ?>
		<div class="bt-print__block">
		   <h6 class="bt-print__header" style="color: <?php echo $print_color; ?> !important;">General Information</h6>
		   <p>
		...
		<div class="bt-print__block">
		   <h6 class="bt-print__header" style="color: <?php echo $print_color; ?> !important;">Exterior Information</h6>
		   <p>
		...
		<div class="bt-print__block">
		   <h6 class="bt-print__header" style="color: <?php echo $print_color; ?> !important;">Interior Information</h6>
		   <p>
