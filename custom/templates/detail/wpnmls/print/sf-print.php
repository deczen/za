<div class="zy-print__wrap">
	<div class="zy-print__header_top">
	 ...
	 <div class="zy-print__left">
		...
		<?php endif; ?>
		<div class="zy-print__block">
		   <h6 class="zy-print__header" style="color: <?php echo $print_color; ?> !important;">General Information</h6>
		   <p>
		...
		<div class="zy-print__block">
		   <h6 class="zy-print__header" style="color: <?php echo $print_color; ?> !important;">Exterior Information</h6>
		   <p>
		...
		<div class="zy-print__block">
		   <h6 class="zy-print__header" style="color: <?php echo $print_color; ?> !important;">Interior Information</h6>
		   <p>
			  ...
			  <strong>Heat Type 2</strong>
			  [unmapped_HeatType2]
			  <?php endif; ?>
			  <?php if(isset($single_property->fireplaces)): ?>
			   <strong>Number of Fireplaces</strong>
			  [fireplaces]
			  <?php endif; ?>
			  ...
			  <?php if(isset($single_property->unmapped->BathsFullLocations)): ?>
			   <strong>Full Bath Locations</strong>
			  [unmapped_BathsFullLocations]
			  <?php endif; ?>
			  <?php if(isset($single_property->unmapped->BathsPartialLocations)): ?>
			   <strong>Partial Bath Locations</strong>
			  [unmapped_BathsPartialLocations]
			  <?php endif; ?>
		   </p>
		</div>
