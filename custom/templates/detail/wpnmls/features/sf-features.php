<ul class="grid grid--gutters grid-xs--full grid-lg--thirds">
	...
	<li class="cell">
		<h3 class="bt-listing__headline">General Information</h3>
		<table class="bt-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="bt-listing__table__label">Parking</td>
				...
				<tr>
					<td class="bt-listing__table__label">Short Sale</td>
					<td class="bt-listing__table__items"><span>[shortsalelenderappreqd]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->Foreclosure)): ?>
				<tr>
					<td class="bt-listing__table__label">Foreclosure</td>
					<td class="bt-listing__table__items"><span>[unmapped_Foreclosure]</span></td>
				</tr>
				<?php endif; ?>
	...
	<li class="cell">
		<h3 class="bt-listing__headline">Exterior Information</h3>
		<table class="bt-listing__table">
			...
			<tbody>
				...
				<tr>
					<td class="bt-listing__table__label">Acres</td>
					<td class="bt-listing__table__items"><span>[acre]</span></td>
				</tr>
				<?php endif; ?>		
				<?php if( isset($single_property->lotsize)): ?>
				<tr>
					<td class="bt-listing__table__label">Lot Dimensions</td>
	...
	<li class="cell">
		...
		<h3 class="bt-listing__headline">Interior Information</h3>
		<table class="bt-listing__table">
			<tbody>
				...
				<tr>
					<td class="bt-listing__table__label">Heat Type 2</td>
					<td class="bt-listing__table__items"><span>[unmapped_HeatType2]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->fireplaces)): ?>
				<tr>
					<td class="bt-listing__table__label">Number of Fireplaces</td>
				...
				<tr>
					<td class="bt-listing__table__label">Basement Access</td>
					<td class="bt-listing__table__items"><span>[basementfeature]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->basement)): ?>
				<tr>
					<td class="bt-listing__table__label">Basemet Description</td>
					<td class="bt-listing__table__items"><span>[basement]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->BathsFullLocations)): ?>
				<tr>
					<td class="bt-listing__table__label">Full Bath Locations</td>
					<td class="bt-listing__table__items"><span>[unmapped_BathsFullLocations]</span></td>
				</tr>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->BathsPartialLocations)): ?>
				<tr>
					<td class="bt-listing__table__label">Partial Bath Locations</td>
					<td class="bt-listing__table__items"><span>[unmapped_BathsPartialLocations]</span></td>
				</tr>
				<?php endif; ?>		
			</tbody>
		</table>
		...
		<h3 class="bt-listing__headline">School Information</h3>
		<table class="bt-listing__table">
			<tbody>
				<?php if( isset($single_property->schooldistrict)): ?>
				<tr>
