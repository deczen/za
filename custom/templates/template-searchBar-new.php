...
<div id="omnibar-tools" class="<?php echo ( !$is_detail_page&&!$is_map_explore||$is_search_apply ) && ( !isset($requests['fixed_search_form']) || isset($requests['fixed_search_form']) && $requests['fixed_search_form'] )? 'fixedheader' : ''; ?>">
	...
	<div class="desktop-omnibar">
		...
		<div class="row">
			...
			<div class="filter-column pc-filter-column col-sm-5">
				<form>
	...
	<div class="zy_filter-wrap hideonprint">
		...
		<?php endif; ?>
		<div class="<?php echo !isset($requests['disableviewbar']) || isset($requests['disableviewbar']) && ! $requests['disableviewbar'] ? 'zy_col-2' : 'zy_col-full'; ?>" id="zpa-view-selected-filter">
