					...
					<div class="slider-container">
						...
						if( isset( $property->photoList ) && sizeof( $property->photoList ) ){
							...
							foreach ($property->photoList as $pic ){ ?>
								...
								<?php else: ?>
								<div style="background-image: url('<?php echo $pic->imgurl ? str_replace('http://','//', str_replace(' ', '%20', $pic->imgurl ) ) : ZIPPERAGENTURL . "images/no-photo.jpg"; ?>');" class="item <?php if($index==0) echo "active"; ?> zpa-results-grid-photo" ><a class="property_url" href="<?php echo $single_url ?>"></a></div>
								<?php endif; ?>
							<?php 
							$index++;
							}
