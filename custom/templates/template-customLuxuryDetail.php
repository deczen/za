...
if(interface_exists('zipperAgentConstants')){
	$listing=get_option(zipperAgentConstants::OPTION_VIRTUAL_PAGE_PERMALINK_TEXT_LUXURY_DETAIL,null);
}
...
if( $listing ){
	...
	if($single_property){
		...
		include ZIPPERAGENTPATH . "/custom/templates/luxury/template-defaultLuxuryDetail.php";
		$html=ob_get_clean();
	}
