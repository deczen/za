...
?><div id="zpa-main-container" class="zpa-container">
	<div id="omnibar-wrap">
		<form id="searchProperties" class="form-inline zpa-quick-search-form" action="<?php echo zipperagent_page_url( 'search-results' ) ?>" method="GET">
			<div class="row">
						...
						<div id="zpa-search-location-tab" class="tab-pane active">
							...
							<div class="row">
								<div class="col-xs-12 col-sm-12">
									<input type="hidden" id="qs-price-slider-range-1" />
								</div>
							</div>
						</div>
	...
	<script>
		var $range = jQuery("#qs-price-slider-range-1");
