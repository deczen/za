<ul class="zy-features-grid">
	...
	<?php if( isset($single_property->lotsize) ): ?>
					<li>Lot Size Area Maximum: [lotsize]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'CurrentUse'}) ): ?>
					<li>Present Use: [unmapped_CurrentUse]</li>
				<?php endif; ?>
	...
	<?php if( isset($single_property->beachdescription) || isset($single_property->waterbodyname) || isset($single_property->unmapped->Dock) || isset($single_property->asscpool) || isset($single_property->roadtype) || isset($single_property->lotdescription) || isset($single_property->unitplacement) || isset($single_property->unmapped->{'Water Access'}) || isset($single_property->unmapped->Waterview) || isset($single_property->waterfrontflag) || isset($single_property->waterfront) || isset($single_property->waterviewFlag) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) ): ?>
	<li class="cell">
