<ul class="zy-features-grid">
	...
	<li class="cell">
		...
		<ul class="zy-sub-list">
				...
				<li>3 Bedroom Units: [unmapped_3 Bedroom: 3 Bedroom # of Units]</li>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Alternate Uses'})): ?>
				<li>Alternate Uses: [unmapped_Alternate Uses]</li>
				<?php endif; ?>
				...
				<li>Dist To Intersection: [unmapped_Dist To Intersxn]</li>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->Exchange) ): ?>
				<li>For Exchange: [unmapped_Exchange]</li>
				<?php endif; ?>
