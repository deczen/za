<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->cctype) || isset($single_property->exterior) || isset($single_property->fireplaces) || isset($single_property->flooring) || isset($single_property->laundrylevel) || isset($single_property->unitlevel) || isset($single_property->petsallowed) || isset($single_property->waterviewfeatures) || isset($single_property->waterfront) || isset($single_property->construction) || isset($single_property->unmapped->ConstructionType) || isset($single_property->unmapped->ConstructionStatus) || isset($single_property->foundation) || isset($single_property->parkingfeature) || isset($single_property->unmapped->Driveway) || isset($single_property->equiplistavail) || isset($single_property->termsfeature) || isset($single_property->interiorfeatures) || isset($single_property->exteriorfeatures) || isset($single_property->unmapped->Porch) || isset($single_property->roofmaterial) || isset($single_property->unmapped->DoorsWindows) || isset($single_property->unmapped->LotDimension) ):?>
	<li class="cell">
