<ul class="zy-features-grid">
	...
	<?php if( isset($single_property->basement) || isset($single_property->nobuildings) || isset($single_property->noofdrivingdoors) || isset($single_property->elevator) || isset($single_property->facilities) || 
			  ...
			  isset($single_property->utilities) || isset($single_property->nostories) || isset($single_property->zonedescription) || isset($single_property->interiorfeatures) || isset($single_property->basementfeature) || 
			  isset($single_property->construction) || isset($single_property->dateavailableformatted) ):?>
	<li class="cell">
