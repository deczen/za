<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || isset($single_property->fireplaces) || 
			  isset($single_property->flooring) || isset($single_property->waterviewfeatures) || isset($single_property->dateavailableformatted) || isset($single_property->nostories) || isset($single_property->roofmaterial) ||
			  isset($single_property->basementfeature) ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
			...
			<li>Available Date: [dateavailableformatted]</li>
			<?php endif; ?>		
