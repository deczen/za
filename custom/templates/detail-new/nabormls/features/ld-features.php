<ul class="zy-features-grid">
	...
	<?php if( isset($single_property->unmapped->{'GulfAccessYN'}) ): ?>
				...
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'LotBack'}) ): ?>
					<li>Lot Back: [unmapped_LotBack]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'LotFrontage'}) ): ?>
					<li>Lot Frontage: [unmapped_LotFrontage]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'LotLeft'}) ): ?>
					<li>Lot Left: [unmapped_LotLeft]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'LotRight'}) ): ?>
					<li>Lot Right: [unmapped_LotRight]</li>
				<?php endif; ?>
	...
	<?php if( isset($single_property->unmapped->{'HOAFee'}) ): ?>
				...
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'LotType'}) ): ?>
					<li>Lot Type: [unmapped_LotType]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'LotUnit'}) ): ?>
					<li>Lot Unit: [unmapped_LotUnit]</li>
				<?php endif; ?>
	...
	<?php if( isset($single_property->unmapped->{'PotentialShortSaleYN'}) ): ?>
				...
				<li>Carport Desc: <?php if($single_property->unmapped->{'CarportYN'}==false){echo "No";}else{echo "Yes";} ?></li>
				<?php endif; ?>
