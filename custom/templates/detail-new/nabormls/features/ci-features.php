<ul class="zy-features-grid">
	...
	<?php if( isset($single_property->unmapped->{'Levels'}) ): ?>
				...
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'LotFrontage'}) ): ?>
					<li>Lot Frontage: [unmapped_LotFrontage]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'CommercialType'}) ): ?>
					<li>Commercial Type: [unmapped_CommercialType]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'ConfidentialityAgreementReqdYN'}) ): ?>
					<li>Confidentiality Agreement Reqd: [unmapped_ConfidentialityAgreementReqdYN]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'ForeclosedREOYN'}) ): ?>
					<li>Foreclosed Reo YN: [unmapped_ForeclosedREOYN]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'LeaseRateDesc'}) ): ?>
					<li>Lease Rate Desc: [unmapped_LeaseRateDesc]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'MaximumSubjectPropertySqFt'}) ): ?>
					<li>Maximum Subject Property Sq Ft: [unmapped_MaximumSubjectPropertySqFt]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'MinimumSubjectPropertySqFt'}) ): ?>
					<li>Minimum Subject Property Sq Ft: [unmapped_MinimumSubjectPropertySqFt]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'PotentialShortSaleYN'}) ): ?>
					<li>Potential Short Sale YN: [unmapped_PotentialShortSaleYN]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'PropertyUseType'}) ): ?>
					<li>Property Use Type: [unmapped_PropertyUseType]</li>
				<?php endif; ?>
	...
	<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'HighSchoolDistrict'})  || isset($single_property->utilities) ||  isset($single_property->cooling) || isset($single_property->heating) || isset($single_property->hotwater) || isset($single_property->unmapped->{'Hot Water Source'}) || isset($single_property->unmapped->{'CoolingYN'}) || isset($single_property->unmapped->{'HeatingYN'})  ):?>
    <li class="cell">
    <?php if( isset($single_property->cooling) || isset($single_property->heating) || isset($single_property->utilities) || isset($single_property->hotwater) || isset($single_property->unmapped->{'Hot Water Source'}) || isset($single_property->unmapped->{'CoolingYN'}) || isset($single_property->unmapped->{'HeatingYN'}) ):?>
