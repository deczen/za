<ul class="zy-features-grid">
	...
	<li class="cell">
		...
		<ul class="zy-sub-list">
				...
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'rentalType'})): ?>
				<li>Rental Type: [unmapped_rentalType]</li>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'securityDepositRequired'})): ?>
				<li>Secuirty Deposit Required: <?php if($single_property->unmapped->{'securityDepositRequired'}==false){echo "No";}else{echo "Yes";} ?></li>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'smokingAllowed'})): ?>
				<li>Smoking Allowed: <?php if($single_property->unmapped->{'smokingAllowed'}==false){echo "No";}else{echo "Yes";} ?></li>
				<?php endif; ?>

				<?php if( isset($single_property->unmapped->{'Smoking'})): ?>
				<li>Smoking: <?php if($single_property->unmapped->{'Smoking'}==false){echo "No";}else{echo "Yes";} ?></li>
				<?php endif; ?>
	...
	<?php if( isset($single_property->unmapped->{'Elevator'}) ): ?>
				...
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'AvailabilityType'}) ): ?>
					<li>Availability Type: [unmapped_AvailabilityType]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'ForSale'}) ): ?>
					<li>For Sale: [unmapped_ForSale]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'MaxNumofOccupants'}) ): ?>
					<li>Max Num Of Occupants: [unmapped_MaxNumofOccupants]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'MinDaysOfLease'}) ): ?>
					<li>Min Days of Lease: [unmapped_MinDaysOfLease]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'OffSeasonRate'}) ): ?>
					<li>Off Season Rate: [unmapped_OffSeasonRate]</li>
				<?php endif; ?>
	...
	<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'HighSchoolDistrict'}) ||  isset($single_property->cooling) || isset($single_property->heating) || isset($single_property->utilities) || isset($single_property->hotwater) || isset($single_property->unmapped->{'Hot Water Source'}) || isset($single_property->unmapped->{'CoolingYN'}) || isset($single_property->unmapped->{'HeatingYN'})  ):?>
    <li class="cell">
