<ul class="zy-features-grid">
	...
	isset($single_property->flooring) /*|| isset($single_property->style)*/ || isset($single_property->waterviewfeatures) || isset($single_property->lotdescription) || isset($single_property->unmapped->HAR_PoolArea) || isset($single_property->unmapped->PoolPrivateYN) ||
	isset($single_property->facingdirection) || isset($single_property->appliances) || isset($single_property->interiorfeatures) || isset($single_property->nostories) || isset($single_property->unmapped->HAR_ApprovalRequired) ||
	isset($single_property->unmapped->HAR_DepositPet) || isset($single_property->unmapped->HAR_DepositSecurity) || isset($single_property->disclosures) || isset($single_property->unmapped->LotSizeSource) || isset($single_property->unmapped->HAR_ManagementCoYN) ||
	isset($single_property->unmapped->HAR_MasterPlannedCommunityYN) || isset($single_property->unmapped->NewConstructionYN) || isset($single_property->leaseterms) || isset($single_property->unmapped->HAR_SmokingAllowed) || isset($single_property->yearbuiltsource) ) :?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
			...
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->HAR_PoolArea)): ?>
			<li>Pool Area: [unmapped_HAR_PoolArea]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->PoolPrivateYN)): ?>
			<li>Private Pool: [unmapped_PoolPrivateYN]</li>
			<?php endif; ?>
			<?php if( isset($single_property->facingdirection)): ?>
			<li>View: [facingdirection]</li>
			<?php endif; ?>
			<?php if( isset($single_property->appliances)): ?>
			<li>Appliances: [appliances]</li>
			<?php endif; ?>
			<?php if( isset($single_property->interiorfeatures)): ?>
			<li>Bedroom Description: [interiorfeatures]</li>
			<?php endif; ?>
			<?php if( isset($single_property->nostories)): ?>
			<li>Stories: [nostories]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->HAR_ApprovalRequired)): ?>
			<li>Approval Required: [unmapped_HAR_ApprovalRequired]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->HAR_DepositPet)): ?>
			<li>Deposit Pet: [unmapped_HAR_DepositPet]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->HAR_DepositSecurity)): ?>
			<li>Deposit Security: [unmapped_HAR_DepositSecurity]</li>
			<?php endif; ?>
			...
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->HAR_MasterPlannedCommunityYN)): ?>
			<li>Master Planned Community YN: [unmapped_HAR_MasterPlannedCommunityYN]</li>
			<?php endif; ?>
			...
			<li>Rental Terms: [leaseterms]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->HAR_SmokingAllowed)): ?>
			<li>Smoking Allowed: [unmapped_HAR_SmokingAllowed]</li>
			<?php endif; ?>
	...
	<li class="cell">
		...
		<?php if( isset($single_property->garagespaces) || isset($single_property->parkingspaces) || isset($single_property->roadtype) || isset($single_property->unmapped->AttachedGarageYN) || isset($single_property->parkingfeature) ):?>
		...
		<ul class="zy-sub-list">
			...
			<li>Garage Attached: [unmapped_AttachedGarageYN]</li>
			<?php endif; ?>
			<?php if( isset($single_property->parkingfeature)): ?>
		...
		<?php if( isset($single_property->taxes) || isset($single_property->taxyear) || isset($single_property->hoafee) || isset($single_property->asscfeeincludes) || isset($single_property->unmapped->HAR_ApplicationFee) || isset($single_property->unmapped->HAR_FeeOther) ):?>
		...
		<ul class="zy-sub-list">
			...
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->HAR_ApplicationFee)): ?>
			<li>Application Fee: [unmapped_HAR_ApplicationFee]</li>
			<?php endif; ?>
