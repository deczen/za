<ul class="zy-features-grid">
	...
	isset($single_property->flooring) /*|| isset($single_property->style)*/ || isset($single_property->waterviewfeatures) || isset($single_property->lotdescription) || isset($single_property->lotdescription) || isset($single_property->unmapped->PoolPrivateYN) ||
	isset($single_property->roofmaterial) || isset($single_property->construction) || isset($single_property->foundation) || isset($single_property->unmapped->HAR_AnnualMaintDesc) || isset($single_property->disclosures) ||
	isset($single_property->unmapped->HAR_FeeOther) || isset($single_property->unmapped->LeaseConsideredYN) || isset($single_property->hoafee) || isset($single_property->yearbuiltsource) || isset($single_property->unmapped->HAR_LotValue) ||
	isset($single_property->unmapped->HAR_MasterPlannedCommunityYN) || isset($single_property->unmapped->NewConstructionYN) || isset($single_property->yearbuiltsource) ) :?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
			...
			<li>Private Pooln: [unmapped_PoolPrivateYN]</li>
			<?php endif; ?>
			<?php if( isset($single_property->roofmaterial)): ?>
			<li>Roof: [roofmaterial]</li>
			<?php endif; ?>
			<?php if( isset($single_property->construction)): ?>
			<li>Siding: [construction]</li>
			<?php endif; ?>
			<?php if( isset($single_property->foundation)): ?>
			<li>Foundation: [foundation]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->HAR_AnnualMaintDesc)): ?>
			<li>Annual Maint Desc: [unmapped_HAR_AnnualMaintDesc]</li>
			<?php endif; ?>
			...
			<li>For Lease: [unmapped_LeaseConsideredYN]</li>
			<?php endif; ?>
			<?php if( isset($single_property->hoafee)): ?>
			<li>Hoa Mandatory: [hoafee]</li>
			<?php endif; ?>
			<?php if( isset($single_property->yearbuiltsource)): ?>
			<li>Lot Size Source: [yearbuiltsource]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->HAR_LotValue)): ?>
			<li>Lot Value: [unmapped_HAR_LotValue]</li>
			<?php endif; ?>
	...
	<li class="cell">
		...
		<?php if( isset($single_property->taxes) || isset($single_property->taxyear) || isset($single_property->hoafee) || isset($single_property->asscfeeincludes) || isset($single_property->unmapped->HAR_TaxRate) ):?>
