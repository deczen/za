<ul class="zy-features-grid">
	<?php if( /*isset($single_property->style) ||*/ isset($single_property->unmapped->Levels) || isset($single_property->unmapped->Stories) || isset($single_property->construction) || isset($single_property->unmapped->{'Construction Status'}) || isset($single_property->exteriorfeatures) || 
		...
		isset($single_property->foundation) || isset($single_property->unmapped->PoolPrivateYN) || isset($single_property->handicapaccess) || isset($single_property->unmapped->BusinessType) || isset($single_property->zoning) || 
		isset($single_property->greencertified) || isset($single_property->warranty) || isset($single_property->unmapped->OwnerPays) || isset($single_property->unmapped->SpecialListingConditions) ):?>
	<li class="cell">
