<ul class="zy-features-grid">
	<?php if( /*isset($single_property->style) ||*/ isset($single_property->unmapped->Levels) || isset($single_property->unmapped->Stories) || isset($single_property->construction) || isset($single_property->unmapped->{'Construction Status'}) || isset($single_property->exteriorfeatures) || 
		...
		isset($single_property->unmapped->PoolPrivateYN) || isset($single_property->unmapped->Vegetation) || isset($single_property->waterfront) || isset($single_property->termsfeature) || isset($single_property->unmapped->ZoningDescription) ||
		isset($single_property->unmapped->CurrentUse) || isset($single_property->zoning) || isset($single_property->warranty) || isset($single_property->unmapped->ListingTerms) || isset($single_property->unmapped->SpecialListingConditions) ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
			...
			<li>Current Classification: [unmapped_ZoningDescription]</li>
			<?php endif; ?>
