<ul class="zy-features-grid">
	...
	<li class="cell">
		...
		<ul class="zy-sub-list">
				...
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->RentingAllowedYN)): ?>
				<li>Renting Allowed YN: [unmapped_RentingAllowedYN]</li>
				<?php endif; ?>
	...
	<li class="cell">
		<?php if( isset($single_property->garagespaces) || isset($single_property->parkingspaces) || isset($single_property->roadtype) || isset($single_property->parkingfeature) || isset($single_property->unmapped->ParkingFee) ):?>
		...
		<ul class="zy-sub-list">
				...
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->ParkingFee)): ?>
				<li>Parking Fee: [unmapped_ParkingFee]</li>
				<?php endif; ?>
