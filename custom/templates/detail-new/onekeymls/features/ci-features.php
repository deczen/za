<ul class="zy-features-grid">
	...
	isset($single_property->petsallowed) || isset($single_property->petrestrictionsallow) || isset($single_property->unmapped->BasementYN) || isset($single_property->unmapped->MainLevelBathrooms) || isset($single_property->unmapped->LeaseConsideredYN) ||
	isset($single_property->unmapped->LotSizeDimensions) || isset($single_property->unmapped->CoolingYN) || isset($single_property->unmapped->MLSAreaMinor) || isset($single_property->zonedescription) ):?>
	<li class="cell">
	...
	<?php if( isset($single_property->unmapped->ElementarySchoolDistrict) || isset($single_property->unmapped->MiddleOrJuniorSchoolDistrict) || isset($single_property->unmapped->HighSchoolDistrict) ):?>
		...
		<ul class="zy-sub-list">
			...
			<li>Grade School: [unmapped_ElementarySchoolDistrict]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->MiddleOrJuniorSchoolDistrict)): ?>
			<li>High School: [unmapped_MiddleOrJuniorSchoolDistrict]</li>
			<?php endif; ?>
