<ul class="zy-features-grid">
	...
	<li class="cell">
		...
		<ul class="zy-sub-list">
				...
				<li>Accessibiiity: [handicapaccess]</li>
				<?php endif; ?>
				...
				<li>Deposit Amount: [unmapped_depositamount]</li>
				<?php endif; ?>
				...
				<li>Pets: [petrestrictionsallow]</li>
				<?php endif; ?>
				...
				<li>School Private: [unmapped_schoolprivate]</li>
				<?php endif; ?>
