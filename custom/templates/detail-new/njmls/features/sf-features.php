<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || isset($single_property->fireplaces) || 
			  isset($single_property->flooring) || isset($single_property->waterviewfeatures) || isset($single_property->unmapped->LIFESTYLE) || isset($single_property->unmapped->MISC) || isset($single_property->unmapped->STREETTYP) || 
			  isset($single_property->unmapped->FLOODPLAIN) || isset($single_property->unmapped->VIEWSEXPOSURE) || isset($single_property->lotdescription) ):?>
