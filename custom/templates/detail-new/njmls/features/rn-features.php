<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->rntype) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || 
			  ...
			  isset($single_property->waterviewfeatures) || isset($single_property->waterfront) || isset($single_property->unmapped->AREANAME) || isset($single_property->unmapped->PROVIDED) || isset($single_property->unmapped->MISCELLANEOUS) || 
			  isset($single_property->unmapped->LIFESTYLE) || isset($single_property->yearbuiltdescrp) || isset($single_property->laundrydscrp) ):?>
