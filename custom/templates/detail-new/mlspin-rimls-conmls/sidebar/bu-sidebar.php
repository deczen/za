<?php if($single_property->sourceid == 'CONMLS'): ?>
	...
	<?php if(isset($single_property->location)): ?><li><label class="col-lg-6 col-sm-6 col-md-6 col-xs-6 col zy_nopadding">Location</label> <span class="col-lg-6 col-sm-6 col-md-6 col-xs-6 col zy_nopadding">[location]</span></li><?php endif; ?>
