<?php if($single_property->sourceid == 'CONMLS'): ?>
	...
	<?php if(isset($single_property->nolots)): ?><li><label class="col-lg-6 col-sm-6 col-md-6 col-xs-6 col zy_nopadding">Approved Lots</label> <span class="col-lg-6 col-sm-6 col-md-6 col-xs-6 col zy_nopadding">[nolots]</span></li><?php endif; ?>
