<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || isset($single_property->fireplaces) || isset($single_property->flooring) /*|| isset($single_property->style)*/ || isset($single_property->waterviewfeatures) || isset($single_property->waterfront) || isset($single_property->zoning) || isset($single_property->noofloadingdocks) || isset($single_property->possession) || isset($single_property->lotdescription) || isset($single_property->direction) || isset($single_property->lot) ):?>
	<li class="cell">
