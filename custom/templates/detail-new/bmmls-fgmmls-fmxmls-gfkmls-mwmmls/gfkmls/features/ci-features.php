<ul class="zy-features-grid">
	...
	<li class="cell">
		...
		<?php if( isset($single_property->parkingspaces) || isset($single_property->parkingfeature) || isset($single_property->garageparking) ):?>
