<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) /*|| isset($single_property->basement)*/ || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || isset($single_property->fireplaces) || isset($single_property->flooring) /*|| isset($single_property->style)*/ || isset($single_property->waterviewfeatures) || isset($single_property->waterfront) || isset($single_property->construction) || isset($single_property->lotdescription) || isset($single_property->roofmaterial) || isset($single_property->waterfrontflag) || isset($single_property->waterbodyname) || isset($single_property->appliances) || isset($single_property->basementfeature) || isset($single_property->basement) || isset($single_property->bathtype) || isset($single_property->dindscrp) || isset($single_property->interiorfeatures) || isset($single_property->buildingconstruction)  ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
				...
				<li>Waterfront Name: [waterbodyname]</li>
				<?php endif; ?>
				...
				<?php endif; ?>
				<?php if( isset($single_property->basement)): ?>
				<li>Basement Style: [basement]</li>
				<?php endif; ?>
				<?php if( isset($single_property->bathtype)): ?>
				<li>Bath Description: [bathtype]</li>
				<?php endif; ?>
				<?php if( isset($single_property->dindscrp)): ?>
				<li>Dining: [dindscrp]</li>
				<?php endif; ?>
				<?php if( isset($single_property->interiorfeatures)): ?>
				<li>Interior Amenities: [interiorfeatures]</li>
				<?php endif; ?>
	...
	<li class="cell">
		...
		<ul class="zy-sub-list">
				...
				<li>Garage Type: [garageparking]</li>
				<?php endif; ?>
