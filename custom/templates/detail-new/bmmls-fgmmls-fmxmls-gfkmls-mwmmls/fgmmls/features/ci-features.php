<ul class="zy-features-grid">
	...
	<li class="cell">
		...
		<ul class="zy-sub-list">
				...
				<li>Foundation Size: [foundation]</li>
				<?php endif; ?>
				...
				<li>For Sale Or Lease: [forsale]</li>
				<?php endif; ?>
				<?php if( isset($single_property->leasepriceincludes)): ?>
				<li>Sale Includes: [leasepriceincludes]</li>
				<?php endif; ?>
