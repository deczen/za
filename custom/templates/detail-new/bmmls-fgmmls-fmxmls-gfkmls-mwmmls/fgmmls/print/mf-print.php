	 ...
	 <div class="zy-print-left">
		...
		<div class="zy-print-block">
		   ...
		   <p>
			  ...
			  <?php endif; ?>
			  <?php if(isset($single_property->squarefeet)): ?>
			  <strong>Above Grade Finished Area</strong>
			  [squarefeet]
			  <?php endif; ?>
			  <?php if(isset($single_property->nounits)): ?>
			  <strong>Total Rental Units</strong>
			  [nounits]
			  <?php endif; ?>
			  ...
			  <strong>Management Expense</strong>
			  [management]
			  <?php endif; ?>
			  ...
			  <strong>Square Foot Source</strong>
			  [squarefeetsource]
			  <?php endif; ?>
			  <?php if(isset($single_property->propsubtype)): ?>
			  <strong>Multifamily Sub Type</strong>
			  [propsubtype]
			  <?php endif; ?>
