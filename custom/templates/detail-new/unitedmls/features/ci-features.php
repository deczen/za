<ul class="zy-features-grid">
	...
	<?php if( isset($single_property->unmapped->{'Inclusions'}) ): ?>
					<li>Price Includes: [unmapped_Inclusions]</li>
				<?php endif; ?>
	...
	<?php if( isset($single_property->utilities) || isset($single_property->heating) || isset($single_property->hotwater) || isset($single_property->unmapped->{'Hot Water Source'}) ):?>
	...
	<?php if( isset($single_property->unmapped->{'OtherParking'}) || isset($single_property->parkingfeature) ):?>
        <h3 class="zy-feature-title">Parking Information</h3>
        <ul class="zy-sub-list">
        
            
                <?php if( isset($single_property->unmapped->{'OtherParking'})): ?>
                <li>OtherParking: <?php echo $single_property->unmapped->{'OtherParking'} ; ?></li>
                <?php endif; ?>    
