<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->rntype) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || isset($single_property->fireplaces) || isset($single_property->flooring) || isset($single_property->laundryfeatures) || isset($single_property->unitlevel) || isset($single_property->petsallowed) || isset($single_property->waterviewfeatures) || isset($single_property->waterfront) || isset($single_property->pooldescription) || isset($single_property->construction) || isset($single_property->parkingfeature) || isset($single_property->roofmaterial) || isset($single_property->lot) || isset($single_property->landdesc) || isset($single_property->dindscrp) || isset($single_property->kitdscrp) || isset($single_property->laundrydscrp) || isset($single_property->firmrmk1) || isset($single_property->termsfeature) || isset($single_property->butype) || isset($single_property->leaseterms) || isset($single_property->rentfeeincludes) || isset($single_property->homeownassociation) || isset($single_property->reqdownassociation) ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
				...
				<?php endif; ?>
				<?php if( isset($single_property->lease)): ?>
				<li>Lease Type: [lease]</li>
				<?php endif; ?>
				<?php if( isset($single_property->leasepriceincludes)): ?>
				<li>Lease Includes: [leasepriceincludes]</li>
				<?php endif; ?>
				<?php if( isset($single_property->leaseterms)): ?>
				<li>Lease Conditions: [leaseterms]</li>
				<?php endif; ?>
				<?php if( isset($single_property->butype)): ?>
	...
	<li class="cell">
		...
		<?php if( isset($single_property->taxyear) || isset($single_property->taxes) || isset($single_property->secdeposit) ):?>
