<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || isset($single_property->fireplaces) || isset($single_property->flooring) || isset($single_property->style) || isset($single_property->waterviewfeatures) || isset($single_property->waterfront) || isset($single_property->construction) || isset($single_property->parkingfeature) || isset($single_property->landdesc) || isset($single_property->roofmaterial) || isset($single_property->pooldescription) || isset($single_property->lot) || isset($single_property->laundrydscrp) || isset($single_property->termsfeature) || isset($single_property->asscfeeincludes) || isset($single_property->specialfinancing) || isset($single_property->reqdownassociation) || isset($single_property->homeownassociation) ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
				...
				<li>Association Fee Incl: [asscfeeincludes]</li>
				<?php endif; ?>
				<?php if( isset($single_property->specialfinancing)): ?>
				<li>Financing: [specialfinancing]</li>
				<?php endif; ?>
