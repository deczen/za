<ul class="zy-features-grid">
	...
	<?php if( isset($single_property->basement) || isset($single_property->citype) /*|| isset($single_property->construction)*/ || isset($single_property->dividable) || isset($single_property->noofdrivingdoors) || isset($single_property->elevator) || isset($single_property->expandable) || isset($single_property->facilities) || isset($single_property->handicapaccess) || isset($single_property->noofloadingdocks) || isset($single_property->noofrestrooms) || isset($single_property->sprinklers) || isset($single_property->utilities) || isset($single_property->construction) || isset($single_property->exterior) || isset($single_property->parkingfeature) || isset($single_property->roofmaterial) || isset($single_property->cooling) || isset($single_property->flooring) || isset($single_property->heating) || isset($single_property->interiorfeatures) || isset($single_property->electricfeature) || isset($single_property->netoperatinginc) || isset($single_property->lot) || isset($single_property->taxes) || isset($single_property->zoning) || isset($single_property->gas) || isset($single_property->sewer) || isset($single_property->water) ):?>
	<li class="cell">
