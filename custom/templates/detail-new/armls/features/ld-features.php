<ul class="zy-features-grid">
	<?php if( isset($single_property->cultivationacres) || isset($single_property->pastureacres) || isset($single_property->timberacres) || isset($single_property->ldtype) || isset($single_property->frontage) || isset($single_property->lotdescription) || isset($single_property->vacant) || isset($single_property->squarefeet) || isset($single_property->electricfeature) || isset($single_property->lot) || isset($single_property->reqdownassociation) || isset($single_property->specialfinancing) ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
				...
				<li>Land Features: [lotdescription]</li>
				<?php endif; ?>
