<ul class="zy-features-grid">
	<?php if( isset($single_property->construction) || isset($single_property->unmapped->{'ConstructionNew'}) || isset($single_property->unmapped->{'Fuel Type'}) || isset($single_property->assessedvaluebldg) || isset($single_property->unmapped->{'leadpaint'}) || isset($single_property->unmapped->{'Lot Size Source'})|| isset($single_property->propsubtype) || isset($single_property->unmapped->{'Separate Living Qtrs'}) || isset($single_property->unmapped->{'Sewer: Septic Tank'}) || isset($single_property->unmapped->{'Special Listing Cond'}) || isset($single_property->unmapped->{'SqFt Source'}) || isset($single_property->water) || isset($single_property->yearbuiltdescrp) || isset($single_property->yearround) || isset($single_property->zoning) ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
				...
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'Fireplaces'})): ?>
				<li>Fireplaces: [unmapped_Fireplaces]</li>
				<?php endif; ?>
				...
				<?php if( isset($single_property->unmapped->{'ApxSqftWarehouseSpace'}) ): ?>
					<li>Apx Sqft Finished: [unmapped_ApxSqftWarehouseSpace]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'AvailableforSale'}) ): ?>
					<li>Available For Sale: [unmapped_AvailableforSale]</li>
				<?php endif; ?>
	<?php if( isset($single_property->dateavailableformatted) ): ?>
					<li>Date Available: [dateavailableformatted]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'TermAvailable'}) ): ?>
					<li>Term Available: [unmapped_TermAvailable]</li>
				<?php endif; ?>
