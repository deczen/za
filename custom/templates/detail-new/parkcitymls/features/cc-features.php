<ul class="zy-features-grid">
	<?php if( isset($single_property->construction) || isset($single_property->unmapped->{'Flood Ins Required'}) || isset($single_property->unmapped->{'Fuel Type'}) || isset($single_property->assessedvaluebldg) || isset($single_property->unmapped->{'leadpaint'}) || isset($single_property->unmapped->{'Lot Size Source'})|| isset($single_property->propsubtype) || isset($single_property->unmapped->{'Separate Living Qtrs'}) || isset($single_property->unmapped->{'Sewer: Septic Tank'}) || isset($single_property->unmapped->{'Special Listing Cond'}) || isset($single_property->unmapped->{'SqFt Source'}) || isset($single_property->water) || isset($single_property->yearbuiltdescrp) || isset($single_property->yearround) || isset($single_property->zoning) ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
				...
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{'MainLevelGreatRoomTotal'}) ): ?>
					<li>Main Level Great Room Total: [unmapped_MainLevelGreatRoomTotal]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'MainLevelLoftTotal'}) ): ?>
					<li>Main Level Loft Total: [unmapped_MainLevelLoftTotal]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'DisabilityFeatures'}) ): ?>
					<li>Disability Features: [unmapped_DisabilityFeatures]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'MotherInLawApartment'}) ): ?>
					<li>Mother In Law Apartment: [unmapped_MotherInLawApartment]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'PotentialApartment'}) ): ?>
					<li>Potential Apartment: [unmapped_PotentialApartment]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'TownhouseUnitLocation'}) ): ?>
					<li>Townhouse Unit Location: [unmapped_TownhouseUnitLocation]</li>
				<?php endif; ?>
	...
	<?php if( isset($single_property->unmapped->{'RanchFees'}) ): ?>
				...
				<?php if( isset($single_property->OtherParking) ): ?>
					<li>Other Park Type: [OtherParking]</li>
				<?php endif; ?>
