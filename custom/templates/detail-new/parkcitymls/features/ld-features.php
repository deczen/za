<ul class="zy-features-grid">
	<?php if( isset($single_property->construction) || isset($single_property->unmapped->{'Access'}) || isset($single_property->unmapped->{'ConstructionNew'}) || isset($single_property->assessedvaluebldg) || isset($single_property->unmapped->{'leadpaint'}) || isset($single_property->unmapped->{'Lot Size Source'})|| isset($single_property->propsubtype) || isset($single_property->unmapped->{'Separate Living Qtrs'}) || isset($single_property->unmapped->{'Sewer: Septic Tank'}) || isset($single_property->unmapped->{'Special Listing Cond'}) || isset($single_property->unmapped->{'SqFt Source'}) || isset($single_property->water) || isset($single_property->yearbuiltdescrp) || isset($single_property->yearround) || isset($single_property->zoning) ):?>
	<li class="cell">
	...
	<?php if( isset($single_property->unmapped->{'OtherParking'}) ): ?>
					<li>Other Park Type: [unmapped_OtherParking]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'AccessUnitHow'}) ): ?>
					<li>Access Unit How: [unmapped_AccessUnitHow]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'ApxYearRemodeled'}) ): ?>
					<li>Apx Year Remodeled: [unmapped_ApxYearRemodeled]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'BankLenderOwned'}) ): ?>
					<li>Bank Lender Owned: [unmapped_BankLenderOwned]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'BuildingType'}) ): ?>
					<li>Building Type: [unmapped_BuildingType]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'ConstructionStatus'}) ): ?>
					<li>Construction Status: [unmapped_ConstructionStatus]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'DisabilityFeatures'}) ): ?>
					<li>Disability Features: [unmapped_DisabilityFeatures]</li>
				<?php endif; ?>
	<?php if( isset($single_property->equiplistavail) ): ?>
					<li>Equipment: [equiplistavail]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'FIType'}) ): ?>
					<li>Fi Type: [unmapped_FIType]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'PotentialApartment'}) ): ?>
					<li>Potential Apartment: [unmapped_PotentialApartment]</li>
				<?php endif; ?>
	...
	<?php if( isset($single_property->unmapped->{'ShortSale'}) ): ?>
				...
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'TimeEquityShareSeasonTimeEqShareIntervalT'}) ): ?>
					<li>Time Equity Share Season Time Eq Share Interval T: [unmapped_TimeEquityShareSeasonTimeEqShareIntervalT]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'TimeEquityShareSeasonTimeEquityShareSeason'}) ): ?>
					<li>Time Equity Share Season Time Equity Share Season: [unmapped_TimeEquityShareSeasonTimeEquityShareSeason]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'TimeEquityShareSeasonTimeWeekIntervalNumb'}) ): ?>
					<li>Time Equity Share Season Time Week Interval Numb: [unmapped_TimeEquityShareSeasonTimeWeekIntervalNumb]</li>
				<?php endif; ?>
	<?php if( isset($single_property->unmapped->{'TimeEquityShareSeasonTimeWeeksIncluded'}) ): ?>
					<li>Time Equity Share Season Time Weeks Included: [unmapped_TimeEquityShareSeasonTimeWeeksIncluded]</li>
				<?php endif; ?>
...
<?php if( isset($single_property->unmapped->{'HOADues'}) || isset($single_property->parkingfeature)|| isset($single_property->taxes) || isset($single_property->taxyear) || isset($single_property->totalassessedvalue) || isset($single_property->unmapped->{'Other Assessments'}) ):?>
    <li class="cell">
    <?php if( isset($single_property->cooling) || isset($single_property->taxes) || isset($single_property->taxyear) || isset($single_property->totalassessedvalue) || isset($single_property->unmapped->{'HOADues'}) ):?>
