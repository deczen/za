<ul class="zy-features-grid">
	...
	<li class="cell">
		...
		<ul class="zy-sub-list">
				...
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->BuildingSize)): ?>
				<li>Building Size: [unmapped_BuildingSize]</li>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->BusinessType)): ?>
				<li>Business Type: [unmapped_BusinessType]</li>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->MaintenanceRepairsExpense)): ?>
				<li>Maintenance Repairs Expense: [unmapped_MaintenanceRepairsExpense]</li>
				<?php endif; ?>
