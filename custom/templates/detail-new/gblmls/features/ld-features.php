<ul class="zy-features-grid">
	<?php if( isset($single_property->cultivationacres) || isset($single_property->pastureacres) || isset($single_property->timberacres) || isset($single_property->ldtype) || isset($single_property->frontage) || 
			...
			isset($single_property->unmapped->Fencing) || isset($single_property->lotdescription) || isset($single_property->unmapped->OtherStructures) || isset($single_property->waterfrontflag) || isset($single_property->unmapped->CurrentUse) || 
   			isset($single_property->unmapped->Fencing) || isset($single_property->lotdescription) || isset($single_property->unmapped->OtherStructures) || isset($single_property->unmapped->ListingTerms) || isset($single_property->unmapped->SpecialListingConditions) ):?>
	<li class="cell">
