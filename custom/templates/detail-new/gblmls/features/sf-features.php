<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || isset($single_property->fireplaces) || 
			...
			isset($single_property->unmapped->AttachedGarageYN) || isset($single_property->construction) || isset($single_property->unmapped->DoorFeatures) || isset($single_property->foundation) || isset($single_property->unmapped->GarageYN) ||
			isset($single_property->lotdescription) || isset($single_property->unmapped->OtherStructures) || isset($single_property->unmapped->PatioAndPorchFeatures) || isset($single_property->roofmaterial) || isset($single_property->waterfrontflag) || 
			isset($single_property->unmapped->WindowFeatures) || isset($single_property->appliances) || isset($single_property->unmapped->FireplaceFeatures) || isset($single_property->unmapped->FireplaceYN) || isset($single_property->interiorfeatures) ||
			isset($single_property->laundryfeatures) || isset($single_property->greencertified) || isset($single_property->unmapped->NewConstructionYN) || isset($single_property->assocsecurity) || isset($single_property->unmapped->SpecialListingConditions) || 
