<ul class="zy-features-grid">
	...
	<li class="cell">
		...
		<ul class="zy-sub-list">
			...
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"Building Features"})): ?>
			<li>Window Features: [unmapped_Building Features]</li>
			<?php endif; ?>	
			...
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"Max Space Available"})): ?>
			<li>Max Space Available: [unmapped_Max Space Available]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"Min Rental Period (months)"})): ?>
			<li>Min Rental Periode: [unmapped_Min Rental Period (months)]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"Other Equipment"})): ?>
			<li>Other Equipment: [unmapped_Other Equipment]</li>
			<?php endif; ?>	
