<div class="zy-print-wrap">
	<div class="zy-print-header-top">
	 ...
	 <div class="zy-print-left">
		...
		<?php endif; ?>
		<div class="zy-print-block">
		   <h6 class="zy-print-header" style="color: <?php echo $print_color; ?> !important;">General Information</h6>
		   <p>
			  <?php /*if(isset($single_property->style)): ?>
			  <strong>Style</strong>
			  [style]
		...
		<div class="zy-print-block">
		   <h6 class="zy-print-header" style="color: <?php echo $print_color; ?> !important;">Exterior Information</h6>
		   <p>
		...
		<div class="zy-print-block">
		   <h6 class="zy-print-header" style="color: <?php echo $print_color; ?> !important;">Interior Information</h6>
		   <p>
