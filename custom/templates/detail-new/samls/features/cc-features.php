<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->cctype) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || 
			  ...
			  isset($single_property->waterviewfeatures) || isset($single_property->waterfront) || isset($single_property->unmapped->{"Entry Level"}) || isset($single_property->foundation) || isset($single_property->unmapped->{"Stories in Building"}) ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
			...
			<?php if( isset($single_property->unmapped->{"Entry Level"})): ?>
			<li>Entry Level: [unmapped_Entry Level]</li>
			<?php endif; ?>
			<?php if( isset($single_property->foundation)): ?>
			<li>Foundation: [foundation]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Stories in Building"})): ?>
			<li>Stories in Building: [unmapped_Stories in Building]</li>
			<?php endif; ?>
			...
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->FLOOR)): ?>
			<li>Floor: [unmapped_FLOOR]</li>
			<?php endif; ?>
			...
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"UNIT LEVELS"})): ?>
			<li>Unit Levels: [unmapped_UNIT LEVELS]</li>
			<?php endif; ?>
			...
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->Building)): ?>
			<li>Building: [unmapped_Building]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Condo Name"})): ?>
			<li>Condo Name: [unmapped_Condo Name]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"CONDOMINIUM MANAGEMENT"})): ?>
			<li>Condominium Management: [unmapped_CONDOMINIUM MANAGEMENT]</li>
			<?php endif; ?>
			...
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"FEE INCLUDES"})): ?>
			<li>Fee Includes: [unmapped_FEE INCLUDES]</li>
			<?php endif; ?>
			...
			<li>Taxed by Mltpl Counties: [unmapped_Taxed by Mltpl Counties]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Total Units"})): ?>
			<li>Total Units: [unmapped_Total Units]</li>
			<?php endif; ?>
	...
	<li class="cell">
		...
		<?php if( isset($single_property->taxes) || isset($single_property->taxyear) || isset($single_property->hoafee) || isset($single_property->asscfeeincludes) || isset($single_property->reqdownassociation) ||
				  isset($single_property->unmapped->{"Multiple HOA"}) || isset($single_property->homeownassociation) ):?>
		...
		<ul class="zy-sub-list">
			...
			<li>HOA Name: [homeownassociation]</li> <!-- not done -->
			<?php endif; ?>
