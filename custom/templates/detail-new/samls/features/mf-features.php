<ul class="zy-features-grid">
	<?php if( 
		...
		isset($single_property->unmapped->{"Subdivision Legal Name"}) ||
		...
		isset($single_property->unmapped->ROOFING) ||
		isset($single_property->unmapped->{"U1 #Parking Spaces"}) ||
		isset($single_property->unmapped->{"U2 #Parking Spaces"}) ||
		isset($single_property->unmapped->{"U2 Park Type"}) ||
		isset($single_property->aircondition) ||
		isset($single_property->unmapped->HEAT) ||
		isset($single_property->unmapped->{"U1 Bdrm"}) ||
		isset($single_property->unmapped->{"U1 Fulls Baths"}) ||
		isset($single_property->unmapped->{"U1 Half Baths"}) ||
		isset($single_property->unmapped->{"U1 Handicap Access"}) ||
		isset($single_property->unmapped->{"UNIT 1 INFO"}) ||
		isset($single_property->unmapped->{"U2 Bdrm"}) ||
		isset($single_property->unmapped->{"U2 Full Baths"}) ||
		isset($single_property->unmapped->{"U2 Full Baths"}) ||
		isset($single_property->unmapped->{"U2 Handicap Access"}) ||
		isset($single_property->unmapped->{"UNIT 2 INFO"}) ||
		isset($single_property->unmapped->{"Annual Operating Expense"}) ||
		isset($single_property->unmapped->{"Apprx Age"}) ||
		isset($single_property->unmapped->{"Builder Name"}) ||
		isset($single_property->unmapped->Construction) ||
		isset($single_property->soldvsrent) ||
		isset($single_property->grossannualincome) ||
		isset($single_property->reqdownassociation) ||
		isset($single_property->unmapped->{"Net Operating Income"}) ||
		isset($single_property->unmapped->{"OP EXP INCLUDES"}) ||
		isset($single_property->unmapped->{"Potential Short Sale"}) ||
		isset($single_property->termsfeature) ||
		isset($single_property->unmapped->{"Recent Rehab"}) ||
		isset($single_property->squarefeetsource) ||
		isset($single_property->unmapped->{"Subdivision Legal Name"}) ||
		isset($single_property->unmapped->{"Taxed by Mltpl Counties"}) ||
		isset($single_property->unmapped->{"U1 Rent"}) ||
		isset($single_property->unmapped->{"U2 Rent"}) ||
		isset($single_property->unmapped->{"% Vacancy Rate"}) ||
		isset($single_property->unmapped->{"% Vacancy Rate"})
		):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
			...
			<?php if( isset($single_property->unmapped->ROOFING)): ?>
			<li>Roof : [unmapped_ROOFING]</li>
			<?php endif; ?>			
			<?php if( isset($single_property->unmapped->{"U1 #Parking Spaces"})): ?>
			<li>Unit One Parking Spaces : [unmapped_U1 #Parking Spaces]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"U1 Park Type"})): ?>
			<li>Unit One Parking Type : [unmapped_U1 Park Type]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"U2 #Parking Spaces"})): ?>
			<li>Unit Two Parking Spaces : [unmapped_U2 #Parking Spaces]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"U2 Park Type"})): ?>
			<li>Unit Two Parking Type : [unmapped_U2 Park Type]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->aircondition)): ?>
			<li>Features : [aircondition]</li>
			<?php endif; ?>				
			<?php if( isset($single_property->unmapped->HEAT)): ?>
			<li>Heat : [unmapped_HEAT]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"U1 Bdrm"})): ?>
			<li>Unit One Beds : [unmapped_U1 Bdrm]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"U1 Fulls Baths"})): ?>
			<li>Unit One Full Baths : [unmapped_U1 Fulls Baths]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"U1 Half Baths"})): ?>
			<li>Unit One Half Baths : [unmapped_U1 Half Baths</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"U1 Handicap Access"})): ?>
			<li>Unit One Handicap Access : [unmapped_U1 Handicap Access]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"UNIT 1 INFO"})): ?>
			<li>Unit One Info : [unmapped_UNIT 1 INFO]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"U2 Bdrm"})): ?>
			<li>Unit Two Beds : [unmapped_U2 Bdrm]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"U2 Full Baths"})): ?>
			<li>Unit Two Full Baths : [unmapped_U2 Full Baths]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"U2 Half Baths"})): ?>
			<li>Unit Two Half Baths : [unmapped_U2 Full Baths]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"U2 Handicap Access"})): ?>
			<li>Unit Two Handicap Access : [unmapped_U2 Handicap Access]</li>
			<?php endif; ?>				
			<?php if( isset($single_property->unmapped->{"UNIT 2 INFO"})): ?>
			<li>Unit Two Info : [unmapped_UNIT 2 INFO]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"Annual Operating Expense"})): ?>
			<li>Annual Operating Expense : [unmapped_Annual Operating Expense]</li>
			<?php endif; ?>	
			...
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->Construction)): ?>
			<li>Construction : [unmapped_Construction]</li>
			<?php endif; ?>	
			...
			<?php endif; ?>				
			<?php if( isset($single_property->unmapped->METERS)): ?>
			<li>Meters : [unmapped_METERS]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"Net Operating Income"})): ?>
			<li>Net Operating Income : [unmapped_Net Operating Income]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"OP EXP INCLUDES"})): ?>
			<li>Operating Expense Includes : [unmapped_OP EXP INCLUDES]</li>
			<?php endif; ?>	
			...
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"U1 Rent"})): ?>
			<li>Unit One Rent : [unmapped_U1 Rent]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"U2 Rent"})): ?>
			<li>Unit Two Rent : [unmapped_U2 Rent]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"% Vacancy Rate"})): ?>
			<li>Vacancy Rate : [unmapped_% Vacancy Rate]</li>
			<?php endif; ?>	
