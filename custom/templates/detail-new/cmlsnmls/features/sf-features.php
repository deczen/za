<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || isset($single_property->fireplaces) || 
			...
			isset($single_property->unmapped->CarportYN) || isset($single_property->construction) || isset($single_property->unmapped->ConstructionType) || isset($single_property->foundation) || isset($single_property->unmapped->GarageYN) ||
			isset($single_property->unmapped->Levels) || isset($single_property->lotdescription) || isset($single_property->unmapped->MainLevelGarageYN) || isset($single_property->unmapped->PatioAndPorchFeatures) || isset($single_property->unmapped->RoadResponsibility) ||
			isset($single_property->unmapped->WindowFeatures) || isset($single_property->unmapped->AboveGradeFinishedArea) || isset($single_property->appliances) || isset($single_property->unmapped->BasementYN) || isset($single_property->unmapped->BelowGradeFinishedArea) ||
			isset($single_property->unmapped->DoorFeatures) || isset($single_property->unmapped->FireplaceFeatures) || isset($single_property->unmapped->FireplaceYN) || isset($single_property->interiorfeatures) || isset($single_property->laundryfeatures) ||
			isset($single_property->unmapped->SqFtLower) || isset($single_property->unmapped->SqFtMain) || isset($single_property->unmapped->SqFtUpper) || isset($single_property->unmapped->SqFtUnheatedTotal) || isset($single_property->unmapped->SqFtThird) ||
			isset($single_property->unmapped->Assumable) || isset($single_property->unmapped->AuctionYN) || isset($single_property->unmapped->CCRSubjectTo) || isset($single_property->unmapped->CityTaxesPaidTo) || isset($single_property->unmapped->NewConstructionYN) ||
			isset($single_property->unmapped->SeniorCommunityYN) || isset($single_property->unmapped->SpecialListingConditions) ||
			isset($single_property->unmapped->OpenParkingSpaces) || isset($single_property->unmapped->CarportSpaces) || isset($single_property->unmapped->EntryLevel) || isset($single_property->unmapped->AdditionalParcelsDescription) || isset($single_property->unmapped->Elevation) ||
			isset($single_property->unmapped->ListingTerms) ||
			isset($single_property->roofmaterial) || isset($single_property->unmapped->BuilderName) || isset($single_property->termsfeature) || isset($single_property->unmapped->DevelopmentStatus) || isset($single_property->unmapped->BuilderModel) ||
			isset($single_property->assocsecurity) ||
			isset($single_property->unmapped->Fencing) || isset($single_property->unmapped->OtherStructures) || isset($single_property->unmapped->OtherStructures) || isset($single_property->zoning) ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
			...
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->MainLevelGarageYN)): ?>
			<li>Main Level Garage YN: [unmapped_MainLevelGarageYN]</li>
			<?php endif; ?>
			...
			<li>Fireplace Features: [unmapped_FireplaceYN]</li>
			<?php endif; ?>
			...
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->SqFtLower)): ?>
			<li>Lower Square Feet: [unmapped_SqFtLower]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->SqFtMain)): ?>
			<li>Main Square Feet: [unmapped_SqFtMain]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->SqFtUpper)): ?>
			<li>Sq Ft Upper: [unmapped_SqFtUpper]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->SqFtUnheatedTotal)): ?>
			<li>Sq Ft Unheated Total: [unmapped_SqFtUnheatedTotal]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->SqFtThird)): ?>
			<li>Third Square Feet: [unmapped_SqFtThird]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->Assumable)): ?>
			<li>Assumable YN: [unmapped_Assumable]</li>
			<?php endif; ?>
			...
			<li>Assigned Spaces: [unmapped_OpenParkingSpaces]</li>
			<?php endif; ?>
			...
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->BuilderModel)): ?>
			<li>Model: [unmapped_BuilderModel]</li>
			<?php endif; ?>
	...
	<li class="cell">
		...
		<?php if( isset($single_property->taxes) || isset($single_property->taxyear) || isset($single_property->hoafee) || isset($single_property->asscfeeincludes) || isset($single_property->feeinterval) || 
				  ...
				  isset($single_property->unmapped->AssociationAnnualExpense) || isset($single_property->unmapped->HOASubjectTo) || isset($single_property->unmapped->HOASubjectToDues) || 
		...
		<ul class="zy-sub-list">
			...
			<?php if( isset($single_property->unmapped->AssociationAnnualExpense)): ?>
			<li>Association Annual Expense: [unmapped_AssociationAnnualExpense]</li>
			<?php endif; ?>
