<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->rntype) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || 
			...
			isset($single_property->lotdescription) || isset($single_property->unmapped->MainLevelGarageYN) || isset($single_property->unmapped->RoadResponsibility) || isset($single_property->unmapped->AboveGradeFinishedArea) || isset($single_property->appliances) ||
			isset($single_property->unmapped->BasementYN) || isset($single_property->unmapped->BelowGradeFinishedArea) || isset($single_property->unmapped->BuildingAreaTotal) || isset($single_property->laundryfeatures) || isset($single_property->unmapped->Assumable) ||
			isset($single_property->unmapped->AuctionYN) || isset($single_property->unmapped->CCRSubjectTo) || isset($single_property->unmapped->CityTaxesPaidTo) || isset($single_property->unmapped->DevelopmentStatus) || isset($single_property->unmapped->ListingTerms) ||
			isset($single_property->unmapped->NewConstructionYN) || isset($single_property->petsallowed) || isset($single_property->unmapped->SeniorCommunityYN) || isset($single_property->unmapped->SpecialListingConditions) || isset($single_property->tenantexpanses) ):?>
	<li class="cell">
	...
	<li class="cell">
		...
		<?php if( isset($single_property->taxes) || isset($single_property->taxyear) || isset($single_property->hoafee) || isset($single_property->asscfeeincludes) || isset($single_property->feeinterval) || 
				  isset($single_property->reqdownassociation) || isset($single_property->unmapped->HOASubjectTo) ):?>
