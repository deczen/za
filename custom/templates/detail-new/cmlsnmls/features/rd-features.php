<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->rntype) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || 
			  ...
			  isset($single_property->unmapped->GarageYN) || isset($single_property->unmapped->Levels) || isset($single_property->unmapped->MainLevelGarageYN) || isset($single_property->unmapped->AboveGradeFinishedArea) || isset($single_property->appliances) ||
			  isset($single_property->unmapped->FireplaceYN) || isset($single_property->furnished) || isset($single_property->interiorfeatures) || isset($single_property->unmapped->SqFtMain) || isset($single_property->unmapped->SqFtUnheatedTotal) ||
