<ul class="zy-features-grid">
	...
	<li class="cell">
		...
		<ul class="zy-sub-list">
			...
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"Number of Buildings"})): ?>
				<li>Number of Buildings: [unmapped_Number of Buildings]</li>
			<?php endif; ?>	
			...
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"Number of Units"})): ?>
	...
	<li>
		<?php if( 
			...
			isset($single_property->unmapped->{"Present Rental Terms"}) ||
			isset($single_property->unmapped->{"Annual Rent"}) ||
			isset($single_property->unmapped->{"Three Bedroom Rental"}) ||
			isset($single_property->unmapped->{"Two Bedroom Rentals"}) 
			):?>
		...
		<ul class="zy-sub-list">
			...
			<?php if( isset($single_property->unmapped->{"Present Rental Terms"})): ?>
				<li>Present Rental Terms: [unmapped_Present Rental Terms]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"Annual Rent"})): ?>
				<li>Annual Rent: [unmapped_Annual Rent]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Three Bedroom Rental"})): ?>
				<li>Three Bedroom Rental: [unmapped_Three Bedroom Rental]</li>
			<?php endif; ?>	
			<?php if( isset($single_property->unmapped->{"Two Bedroom Rentals"})): ?>
				<li>Two Bedroom Rentals: [unmapped_Two Bedroom Rentals]</li>
			<?php endif; ?>				
