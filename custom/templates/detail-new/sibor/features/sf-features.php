<ul class="zy-features-grid">
	...
	<li class="cell">
		...
		<ul class="zy-sub-list">
				...
				<li>Lot Dimension: [lotdescription]</li>
				<?php endif; ?>
				...
				<li>Siding: [GF20140818190447585531000000]</li>
				<?php endif; ?>
				<?php if( isset($single_property->nostories)): ?>
				<li>Stories: [nostories]</li>
				<?php endif; ?>
				<?php if( isset($single_property->kitdscrp)): ?>
				<li>Kitchen Description: [kitdscrp]</li>
				<?php endif; ?>
	...
	<?php if( isset($single_property->aircondition) || isset($single_property->sewer) || isset($single_property->coolingunits) || isset($single_property->sprinklers) || isset($single_property->heatunits) || isset($single_property->heating) || isset($single_property->GF20140818190041937135000000) ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
				...
				<li>Heat System: [GF20140818190041937135000000]</li>
				<?php endif; ?>			
