<ul class="zy-features-grid">
	<?php if( isset($single_property->unmapped->InternetAddressDisplayYN) || isset($single_property->unmapped->LotSizeSource) || isset($single_property->unmapped->StoriesTotal) || isset($single_property->unmapped->CarportSpaces) || isset($single_property->unmapped->FarmCreditServiceInclYN) ||
			  isset($single_property->unmapped->Elevation) || isset($single_property->unmapped->ElectricOnPropertyYN) || isset($single_property->unmapped->PropertyAttachedYN) || isset($single_property->unmapped->SeniorCommunityYN) || isset($single_property->unmapped->IrrigationSource) ||
			  isset($single_property->unmapped->IrrigationWaterRightsAcres) || isset($single_property->unmapped->HorseYN) || isset($single_property->unmapped->NumberOfSeparateWaterMeters) || isset($single_property->unmapped->CarportYN) || isset($single_property->unmapped->NumberOfSeparateElectricMeters) ||
			  isset($single_property->unmapped->SpaYN) || isset($single_property->unmapped->LotSizeArea) || isset($single_property->unmapped->GrazingPermitsPrivateYN) || isset($single_property->unmapped->NumberOfSeparateGasMeters) || isset($single_property->unmapped->NewConstructionYN) ||
			  isset($single_property->unmapped->InternetAutomatedValuationDisplayYN) || isset($single_property->unmapped->InternetEntireListingDisplayYN) || isset($single_property->unmapped->CoveredSpaces) || isset($single_property->unmapped->CropsIncludedYN) || isset($single_property->unmapped->IrrigationWaterRightsYN) ||
			  isset($single_property->unmapped->PoolPrivateYN) || isset($single_property->unmapped->MobileHomeRemainsYN) || isset($single_property->unmapped->WoodedArea) || isset($single_property->unmapped->HabitableResidenceYN) || isset($single_property->vacant) ||
			  isset($single_property->lotsize) || isset($single_property->foundationsize) || isset($single_property->homeownassociation) || isset($single_property->netoperatinginc) || isset($single_property->grossannualincome) ||
			  isset($single_property->unmapped->GrossScheduledIncome) || isset($single_property->unmapped->AboveGradeFinishedArea) ):?>
	<li class="cell">
		<h3 class="zy-feature-title">Property Features</h3>
		<ul class="zy-sub-list">
			<?php if( isset($single_property->unmapped->InternetAddressDisplayYN)): ?>
			<li>Internet Address Display: [unmapped_InternetAddressDisplayYN]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->LotSizeSource)): ?>
			<li>Lots Size: [unmapped_LotSizeSource]</li>
			<?php endif; ?>
			...
			<li>Farm CreditService Include: [unmapped_FarmCreditServiceInclYN]</li>
			<?php endif; ?>
			...
			<li>Attached Property: [unmapped_PropertyAttachedYN]</li>
			<?php endif; ?>
			...
			<li>Irrigation Water Acres: [unmapped_IrrigationWaterRightsAcres]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->HorseYN)): ?>
			<li>Horse: [unmapped_HorseYN]</li>
			<?php endif; ?>
			...
			<li>Private Grazing Permits YN: [unmapped_GrazingPermitsPrivateYN]</li>
			<?php endif; ?>
			...
			<li>Internet Entire Listing Display: [unmapped_InternetEntireListingDisplayYN]</li>
			<?php endif; ?>
	...
	<li class="cell">
		...
		<?php if( isset($single_property->taxyear) || isset($single_property->taxes) || isset($single_property->unmapped->InsuranceExpense) || isset($single_property->unmapped->WaterSewerExpense) || isset($single_property->unmapped->CableTvExpense) ||
			  isset($single_property->unmapped->PoolExpense) || isset($single_property->unmapped->ManagerExpense) || isset($single_property->unmapped->GardnerExpense) || isset($single_property->unmapped->MaintenanceExpense) || isset($single_property->unmapped->TrashExpense) ||
			  isset($single_property->unmapped->ElectricExpense) || isset($single_property->unmapped->FuelExpense) || isset($single_property->unmapped->SuppliesExpense) || isset($single_property->unmapped->PestControlExpense) || isset($single_property->unmapped->NewTaxesExpense) ||
			  isset($single_property->unmapped->FurnitureReplacementExpense) || isset($single_property->unmapped->OperatingExpense) || isset($single_property->unmapped->LicensesExpense) || isset($single_property->unmapped->WorkmansCompensationExpense) || isset($single_property->unmapped->TaxOtherAnnualAssessmentAmount) ||
			  isset($single_property->unmapped->AssociationFee2) || isset($single_property->unmapped->OtherExpense) || isset($single_property->hoafee) ): ?>
		...
		<ul class="zy-sub-list">
			...
			<li>ElectricExpense: [unmapped_ElectricExpense]</li>
			<?php endif; ?>
		...
		<ul class="zy-sub-list">
			...
			<li>No.Of Fireplaces: [fireplaces]</li>
			<?php endif; ?>
	...
	<li class="cell">	
		...
		<?php if( isset($single_property->unmapped->ElementarySchoolDistrict) || isset($single_property->unmapped->MiddleOrJuniorSchoolDistrict) || isset($single_property->unmapped->HighSchoolDistrict) || isset($single_property->gradeschool) || isset($single_property->highschool) || 
		...
		<?php if( isset($single_property->unmapped->GarageYN) || isset($single_property->unmapped->OpenParkingYN) || isset($single_property->unmapped->OpenParkingSpaces) || isset($single_property->unmapped->AttachedGarageYN) || isset($single_property->parkingspaces) ||
		...
		<ul class="zy-sub-list">
			...
			<li>Open Parking: [unmapped_OpenParkingYN]</li>
			<?php endif; ?>
