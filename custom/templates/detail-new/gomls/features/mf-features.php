<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || isset($single_property->fireplaces) || 
			  isset($single_property->flooring) || isset($single_property->waterviewfeatures) || isset($single_property->unmapped->Miscellaneous) || isset($single_property->unmapped->{"Parking per Unit"}) || isset($single_property->unmapped->{"Type Property"}) ||
			  isset($single_property->unmapped->{"# Floors"}) || isset($single_property->unmapped->{"# Efficiency"}) || isset($single_property->unmapped->{"# Furnished"}) || isset($single_property->unmapped->{"# Unfurnished"}) || isset($single_property->unmapped->{"Owner Expense"}) ||
			  isset($single_property->unmapped->Walls) || isset($single_property->vacant) || isset($single_property->style) || isset($single_property->unmapped->lngTOWNSDESCRIPTION) || isset($single_property->totalunits) ||
			  isset($single_property->buildingconstruction) || isset($single_property->tenantexpanses) || isset($single_property->restrictions) || isset($single_property->appliances) || isset($single_property->construction) ||
			  isset($single_property->flooring) || isset($single_property->roofmaterial) || isset($single_property->foundation) || isset($single_property->basement) ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
			...
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Parking per Unit"})): ?>
			<li>Parking per Unit: [unmapped_Parking per Unit]</li>
			<?php endif; ?>
			...
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"# Efficiency"})): ?>
			<li>No of Efficiency: [unmapped_# Efficiency]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"# Furnished"})): ?>
			<li>No of Furnished: [unmapped_# Furnished]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"# Unfurnished"})): ?>
			<li>No of Unfurnished: [unmapped_# Unfurnished]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Owner Expense"})): ?>
			<li>Owner Expense: [unmapped_Owner Expense]</li>
			<?php endif; ?>
	...
	<?php if( isset($single_property->cooling) || isset($single_property->coolingzones) || isset($single_property->heating) || isset($single_property->heatzones) || isset($single_property->energyfeatures) || 
			  isset($single_property->electricfeature) || isset($single_property->hotwater) || isset($single_property->sewer) || isset($single_property->water) || isset($single_property->aircondition) ):?>
	<li class="cell">
	...
	<li>
		<?php if( isset($single_property->taxes) || isset($single_property->taxyear) || isset($single_property->hoafee) || isset($single_property->asscfeeincludes) || isset($single_property->unmapped->{"Tax District"}) ):?>
