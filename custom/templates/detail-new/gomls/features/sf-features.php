<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || isset($single_property->fireplaces) ||
			  isset($single_property->flooring) || isset($single_property->waterviewfeatures) || isset($single_property->appliances) || isset($single_property->construction) || isset($single_property->interiorfeatures) ||
			  isset($single_property->roofmaterial) || isset($single_property->foundation) || isset($single_property->lot) || isset($single_property->unmapped->Foreclosure) || isset($single_property->unmapped->Attic) ||
			  isset($single_property->unmapped->{"Great Room Level"}) || isset($single_property->unmapped->{"Foyer Level"}) || isset($single_property->unmapped->Fireplace) || isset($single_property->unmapped->{"Apx SqFt 1st Level"}) || isset($single_property->unmapped->{"Apx SqFt 2nd Level"}) ||
			  isset($single_property->unmapped->{"Apx SqFt 3rd Level"}) || isset($single_property->vacant) || isset($single_property->unmapped->lngTOWNSDESCRIPTION) || isset($single_property->lotdescription) || isset($single_property->unmapped->{"Kitchen/Dining"}) ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
			...
			<li>Great Room: [unmapped_Great Room Level]</li>
			<?php endif; ?>
			...
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Kitchen/Dining"})): ?>
			<li>Kitchen/Dining: [unmapped_Kitchen/Dining]</li>
			<?php endif; ?>
