<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || isset($single_property->fireplaces) || 
			  isset($single_property->flooring) || isset($single_property->waterviewfeatures) || isset($single_property->unmapped->lngTOWNSDESCRIPTION) || isset($single_property->furnished) || isset($single_property->appliances) ||
			  isset($single_property->totalrent) || isset($single_property->secdeposit) || isset($single_property->unmapped->{"Wheel Chair Access"}) || isset($single_property->unmapped->Pets) || isset($single_property->unmapped->Smoking) ||
			  isset($single_property->vacant) ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
			...
			<?php endif; ?>
			<?php if( isset($single_property->totalrent)): ?>
			<li>Total Rent: [totalrent]</li>
			<?php endif; ?>
			<?php if( isset($single_property->secdeposit)): ?>
			<li>Security Deposit: [secdeposit]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Wheel Chair Access"})): ?>
			<li>Wheel Chair Access: [unmapped_Wheel Chair Access]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->Pets)): ?>
			<li>Pets: [unmapped_Pets]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->Smoking)): ?>
			<li>Smoking: [unmapped_Smoking]</li>
			<?php endif; ?>
