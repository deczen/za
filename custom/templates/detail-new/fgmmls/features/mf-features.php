<ul class="zy-features-grid">
	<?php if( /*isset($single_property->amenities) ||*/ isset($single_property->basement) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || isset($single_property->fireplaces) || isset($single_property->flooring) /*|| isset($single_property->style)*/ || isset($single_property->waterviewfeatures) || isset($single_property->waterfront) || isset($single_property->foundation) || isset($single_property->color) || isset($single_property->roofmaterial) || isset($single_property->waterfrontflag) || isset($single_property->squarefeet) || isset($single_property->nounits) || isset($single_property->grossannualexp) || isset($single_property->management) || isset($single_property->grossannualincome) || isset($single_property->utilities) || isset($single_property->squarefeetsource) || isset($single_property->propsubtype) || isset($single_property->oth1DSCRP) || isset($single_property->amenities) || isset($single_property->lotsize)  ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
			...
			<li>Above Grade Finished Area: [squarefeet]</li>
			<?php endif; ?>
			<?php if( isset($single_property->nounits)): ?>
			<li>Total Rental Units: [nounits]</li>
			<?php endif; ?>
			<?php if( isset($single_property->grossannualexp)): ?>
			<li>Total Expenses: [grossannualexp]</li>
			<?php endif; ?>
			<?php if( isset($single_property->management)): ?>
			<li>Management Expense: [management]</li>
			<?php endif; ?>
			<?php if( isset($single_property->grossannualincome)): ?>
			<li>Total Income: [grossannualincome]</li>
			<?php endif; ?>
			...
			<li>Multifamily Sub Type: [propsubtype]</li>
			<?php endif; ?>
			<?php if( isset($single_property->oth1DSCRP)): ?>
			<li>Other Expense: [oth1DSCRP]</li>
			<?php endif; ?>
			<?php if( isset($single_property->amenities)): ?>
			<li>Other Amenities: [amenities]</li>
			<?php endif; ?>
			<?php if( isset($single_property->lotsize)): ?>
			<li>Lot Size Dimensions: [lotsize]</li>
			<?php endif; ?>
		</ul>
	</li>						
	<?php endif; ?>
