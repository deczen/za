<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->cctype) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || 
			  ...
			  isset($single_property->waterviewfeatures) || isset($single_property->waterfront) || isset($single_property->unmapped->{"For Sale"}) || isset($single_property->unmapped->{"Front Exposure"}) || isset($single_property->unmapped->Pool) ||
			  isset($single_property->asscpool) || isset($single_property->unmapped->{"Pool Dimensions"}) || isset($single_property->unmapped->Style) || isset($single_property->unmapped->{"Type Of Property"}) || isset($single_property->unmapped->{"Waterfront Property YN"}) ||
			  isset($single_property->unmapped->{"Furnished Info List"}) || isset($single_property->interiorfeatures) || isset($single_property->unmapped->{"Rooms Description"}) || isset($single_property->unmapped->{"Zoning Information"}) || isset($single_property->unmapped->{"Equipment Appliances"}) ||
			  isset($single_property->unmapped->{"Furn Annual Rent"}) || isset($single_property->unmapped->{"Furn Seasonal Rent"}) || isset($single_property->unmapped->{"Minimum Lease Period"}) || isset($single_property->unmapped->{"Move In Dollars"}) || isset($single_property->dateavailableformatted) ||
			  isset($single_property->unmapped->LeaseAmountFrequency) ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
			...
			<?php if( isset($single_property->unmapped->{"For Sale"})): ?>
			<li>For Sale: [unmapped_For Sale]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Front Exposure"})): ?>
			<li>Front Exposure: [unmapped_Front Exposure]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->Pool)): ?>
			<li>Pool: [unmapped_Pool]</li>
			<?php endif; ?>
			<?php if( isset($single_property->asscpool)): ?>
			<li>Pool Description: [asscpool]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Pool Dimensions"})): ?>
			<li>Pool Dimensions: [unmapped_Pool Dimensions]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->Style)): ?>
			<li>Style: [unmapped_Style]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Type Of Property"})): ?>
			<li>Property Type: [unmapped_Type Of Property]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Waterfront Property YN"})): ?>
			<li>Waterfront: [unmapped_Waterfront Property YN]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Furnished Info List"})): ?>
			<li>Furnishing: [unmapped_Furnished Info List]</li>
			<?php endif; ?>
			<?php if( isset($single_property->interiorfeatures)): ?>
			<li>Interior Features: [interiorfeatures]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Rooms Description"})): ?>
			<li>Rooms: [unmapped_Rooms Description]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Zoning Information"})): ?>
			<li>Zoning: [unmapped_Zoning Information]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Equipment Appliances"})): ?>
			<li>Appliances: [unmapped_Equipment Appliances]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Furn Annual Rent"})): ?>
			<li>Annual Rent: [unmapped_Furn Annual Rent]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Furn Seasonal Rent"})): ?>
			<li>Seasonal Rent: [unmapped_Furn Seasonal Rent]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Minimum Lease Period"})): ?>
			<li>Minimum Lease Period: [unmapped_Minimum Lease Period]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Move In Dollars"})): ?>
			<li>Move In Dollars: [unmapped_Move In Dollars]</li>
			<?php endif; ?>
			<?php if( isset($single_property->dateavailableformatted)): ?>
			<li>Date Available: [dateavailableformatted]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->LeaseAmountFrequency)): ?>
			<li>Rent Period: [unmapped_LeaseAmountFrequency]</li>
			<?php endif; ?>
	...
	<li class="cell">
		...
		<?php if( isset($single_property->taxes) || isset($single_property->taxyear) || isset($single_property->hoafee) || isset($single_property->asscfeeincludes) || isset($single_property->unmapped->{"Application Fee"}) ):?>
		...
		<ul class="zy-sub-list">
			...
			<li>Application Fee: [unmapped_Application Fee]</li> <!-- not done -->
			<?php endif; ?>			
		</ul>
		<?php endif; ?>
	</li>					
