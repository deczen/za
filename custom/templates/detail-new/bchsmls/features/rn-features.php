<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->rntype) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || 
			  ...
			  isset($single_property->waterviewfeatures) || isset($single_property->waterfront) || isset($single_property->roofmaterial) || isset($single_property->unmapped->YearBuiltDetails) || isset($single_property->bldgsqfeet) ||
		      isset($single_property->unmapped->ListingTerms) || isset($single_property->zonedescription) ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
			...
			<li>Built Description: [unmapped_YearBuiltDetails]</li>
			<?php endif; ?>
	...
	<li class="cell">
		<?php if( isset($single_property->netoperatinginc) || isset($single_property->unmapped->OperatingExpense) ):?>
		<h3 class="zy-feature-title">Taxes, Fees</h3>
		<ul class="zy-sub-list">
			
				<?php if( isset($single_property->netoperatinginc)): ?>
				<li>Annual Net Operating Income: [netoperatinginc]</li>
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->OperatingExpense)): ?>
				<li>Annual Total Expenses: [unmapped_OperatingExpense]</li>
				<?php endif; ?>
