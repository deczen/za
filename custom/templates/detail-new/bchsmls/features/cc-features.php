<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->cctype) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || 
			  ...
			  isset($single_property->waterviewfeatures) || isset($single_property->waterfront) || isset($single_property->roofmaterial) || isset($single_property->unmapped->PropertySubTypeAdditional) || isset($single_property->bldgsqfeet) ||
			  isset($single_property->lotsize) || isset($single_property->zonedescription) ):?>
	<li class="cell">
	...
	<li class="cell">
		...
		<ul class="zy-sub-list">
				...
				<?php endif; ?>
				<?php if( isset($single_property->parkingfeature)): ?>
				<li>Parking Descriptio: [parkingfeature]</li>
				<?php endif; ?>
