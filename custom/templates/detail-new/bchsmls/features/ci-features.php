<ul class="zy-features-grid">
	...
	<li class="cell">
		...
		<h3 class="zy-feature-title">Parking Feature</h3>
		<ul class="zy-sub-list">
	...
	<?php if( isset($single_property->basement) || isset($single_property->citype) || isset($single_property->construction) || isset($single_property->dividable) || isset($single_property->noofdrivingdoors) || 
			  ...
			  isset($single_property->noofrestrooms) || isset($single_property->sprinklers) || isset($single_property->utilities) || isset($single_property->construction) || isset($single_property->roofmaterial) || 
			  isset($single_property->waterfrontflag) || isset($single_property->unmapped->DocumentsCount) || isset($single_property->possession) || isset($single_property->assocsecurity) || isset($single_property->unmapped->ListingTerms) || 
	...
	<li class="cell">
		...
		<ul class="zy-sub-list">
				...
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->DocumentsCount)): ?>
				<li>Available Docs: [unmapped_DocumentsCount]</li>
				<?php endif; ?>
