<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || isset($single_property->fireplaces) || 
			  isset($single_property->flooring) /*|| isset($single_property->style)*/ || isset($single_property->waterviewfeatures) || isset($single_property->facingdirection) || isset($single_property->lotdescription) || isset($single_property->pooldescription) ||
			  isset($single_property->roofmaterial) || isset($single_property->unmapped->View) || isset($single_property->furnished) || isset($single_property->interiorfeatures) || isset($single_property->bldgsqfeet) ||
			  isset($single_property->feeinterval) || isset($single_property->unmapped->MLSAreaMinor) || isset($single_property->petsallowed) || isset($single_property->lotsize) || isset($single_property->adultcommunity) ||
			  isset($single_property->unmapped->ListingTerms) || isset($single_property->unmapped->YearBuiltDetails) || isset($single_property->zonedescription) ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
			...
			<li>Front Exposure: [facingdirection]</li>
			<?php endif; ?>
			...
			<li>Furnished Info List: [furnished]</li>
			<?php endif; ?>
			<?php if( isset($single_property->interiorfeatures)): ?>
			<li>Interior Features: [interiorfeatures]</li>
			<?php endif; ?>
			<?php if( isset($single_property->bldgsqfeet)): ?>
			<li>Sq Ft Total: [bldgsqfeet]</li>
			<?php endif; ?>
			<?php if( isset($single_property->feeinterval)): ?>
			<li>Association Fee Paid Per: [feeinterval]</li>
			<?php endif; ?>
			...
			<li>Subdivision Information: [adultcommunity]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->ListingTerms)): ?>
			<li>Terms Considered: [unmapped_ListingTerms]</li>
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->YearBuiltDetails)): ?>
			<li>Year Built Description: [unmapped_YearBuiltDetails]</li>
			<?php endif; ?>
