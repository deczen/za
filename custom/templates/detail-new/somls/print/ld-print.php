	 ...
	 <div class="zy-print-left">
		...
		<div class="zy-print-block">
		   ...
		   <p>
			...
			<strong>Best Use</strong> [unmapped_Best Use]
			<?php endif; ?>
			...
			<strong>Deed Restrictions</strong> [restrictions]
			<?php endif; ?>
			...
			<strong>Easement</strong> [easements]
			<?php endif; ?>
			<?php if( isset($single_property->elevator)): ?>
			<strong>Elevation</strong> [elevator]
			<?php endif; ?>
			<?php if( isset($single_property->propsubtype)): ?>
			<strong>Land Type</strong> [propsubtype]
			<?php endif; ?>
			...
			<strong>Utilities Available</strong> [utilities]
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Cleared Acreage"})): ?>
			<strong>Cleared Acreage</strong> [unmapped_Cleared Acreage]
			<?php endif; ?>
			...
			<strong>Land Description</strong> [unmapped_Land Descriptions]
			<?php endif; ?>
			...
			<strong>Wooded</strong> [unmapped_Wooded]
			<?php endif; ?>
			<?php if( isset($single_property->unmapped->{"Wooded Acreage"})): ?>
			<strong>Wooded Acreage</strong> [unmapped_Wooded Acreage]
			<?php endif; ?>
		   </p>
		</div>
