<ul class="zy-features-grid">
	...
	<?php if( isset($single_property->unmapped->{'DevelopmentStatus'}) ): ?>
					<li>Development Status: [unmapped_DevelopmentStatus]</li>
				<?php endif; ?>
...
<?php if( isset($single_property->unmapped->{'FrontageLength'}) ): ?>
					<li>Frontage Feet: [unmapped_FrontageLength]</li>
				<?php endif; ?>
	...
	<?php endif; ?>
	<?php if( isset($single_property->utilities) || isset($single_property->unmapped->{'HighSchoolDistrict'}) ||  isset($single_property->cooling) || isset($single_property->heating) || isset($single_property->hotwater) || isset($single_property->unmapped->{'Hot Water Source'}) || isset($single_property->unmapped->{'CoolingYN'}) || isset($single_property->unmapped->{'HeatingYN'})  ):?>
    <li class="cell">
    <?php if( isset($single_property->utilities) || isset($single_property->heating) || isset($single_property->hotwater) || isset($single_property->unmapped->{'Hot Water Source'}) || isset($single_property->unmapped->{'CoolingYN'}) || isset($single_property->unmapped->{'HeatingYN'}) ):?>
    ...
    <?php endif; ?>
	<?php if( $single_property->unmapped->{'HighSchoolDistrict'} || isset($single_property->middleschool) || isset($single_property->highschool) ):?>
...
<?php if(isset($single_property->amenities) || isset($single_property->hoafee) || isset($single_property->unmapped->{'OpenParkingYN'}) || isset($single_property->parkingfeature)|| isset($single_property->amenities) || isset($single_property->taxes) || isset($single_property->taxyear) || isset($single_property->totalassessedvalue) || isset($single_property->unmapped->{'Other Assessments'}) ):?>
    <li class="cell">
    <?php if( isset($single_property->amenities) || isset($single_property->hoafee) || isset($single_property->taxes) || isset($single_property->taxyear) || isset($single_property->totalassessedvalue) || isset($single_property->unmapped->{'Other Assessments'}) ):?>
