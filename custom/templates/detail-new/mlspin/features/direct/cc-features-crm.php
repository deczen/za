<ul class="zy-features-grid">
	{section fields="single_property.amenities,single_property.basement,single_property.cctype,single_property.exteriorfeatures,single_property.exterior,single_property.fireplaces,single_property.flooring,single_property.laundrylevel,single_property.unitlevel,single_property.petsallowed,single_property.waterviewfeatures,single_property.waterfront"}
	<li class="cell">
		...
		<ul class="zy-sub-list">
			...
			{/if}
			{if field="single_property.cctype"}
			...
			{/if}
			{if field="single_property.laundrylevel"}
...
<ul class="zy-features-grid">
	...
	{nested fields="single_property.bth1DIMEN,single_property.bth1LEVEL,single_property.bth1DSCRP,single_property.bth2DIMEN,single_property.bth2LEVEL,single_property.bth2DSCRP,single_property.bth3DIMEN,single_property.bth3LEVEL,single_property.bth3DSCRP"}
	<li class="cell">
