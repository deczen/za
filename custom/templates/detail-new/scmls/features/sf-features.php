<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || isset($single_property->fireplaces) || 
			...
			isset($single_property->unmapped->AttachedGarageYN) || isset($single_property->construction) || isset($single_property->facingdirection) || isset($single_property->unmapped->Fencing) || isset($single_property->unmapped->Levels) ||
			isset($single_property->lotdescription) || isset($single_property->unmapped->PatioAndPorchFeatures) || isset($single_property->roofmaterial) || isset($single_property->unmapped->View) || isset($single_property->waterfrontflag) ||
