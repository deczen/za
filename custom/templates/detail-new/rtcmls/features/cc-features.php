<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->cctype) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || 
			  ...
			  isset($single_property->waterviewfeatures) || isset($single_property->waterfront) || isset($single_property->assocsecurity) || isset($single_property->sitecondition) || isset($single_property->totalunits) ||
			  isset($single_property->unmapped->WaterfrontYN) || isset($single_property->unmapped->LotSizeUnits) || isset($single_property->unmapped->{"Lot Size Dimensions"}) || isset($single_property->unmapped->BuildingAreaUnits) || isset($single_property->bldgsqfeet) ||
			  isset($single_property->vacant) || isset($single_property->possession) || isset($single_property->unmapped->BuildingAreaSource) || isset($single_property->roofmaterial) || isset($single_property->warranty) ||
			  isset($single_property->unmapped->WaterfrontYN) || isset($single_property->yearbuiltdescrp) || isset($single_property->yearbuilt) || isset($single_property->zoning) ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
				...
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->{"Lot Size Dimensions"})): ?>
				<li>Lot Size Dimensions: [unmapped_Lot Size Dimensions]</li>
				<?php endif; ?>
				...
				<?php endif; ?>
				<?php if( isset($single_property->unmapped->WaterfrontYN)): ?>
				<li>Water Front: [unmapped_WaterfrontYN]</li>
				<?php endif; ?>
				<?php if( isset($single_property->yearbuiltdescrp)): ?>
				<li>Year Built descrption: [yearbuiltdescrp]</li>
				<?php endif; ?>
