<ul class="zy-features-grid">
	<?php if( isset($single_property->amenities) || isset($single_property->basement) || isset($single_property->rntype) || isset($single_property->exteriorfeatures) || isset($single_property->exterior) || 
			  ...
			  isset($single_property->waterviewfeatures) || isset($single_property->waterfront) || isset($single_property->bldgsqfeet) || isset($single_property->unmapped->AttachedGarageYN) || isset($single_property->construction) || 
			  isset($single_property->unmapped->Levels) || isset($single_property->unmapped->LotSizeDimensions) || isset($single_property->roofmaterial) || isset($single_property->unmapped->WaterfrontYN) || isset($single_property->unmmaped->FireplaceYN) || 
			  isset($single_property->unmapped->AboveGradeFinishedArea) || isset($single_property->bldgsqfeet) || isset($single_property->grossannualincome) || isset($single_property->laundryfeatures) || isset($single_property->netoperatinginc) || 
			  isset($single_property->unmapped->PropertyAttachedYN) || isset($single_property->sitecondition) || isset($single_property->zoning) ):?>
	<li class="cell">
