<ul class="zy-features-grid">
	...
	<?php if( isset($single_property->basement) || isset($single_property->citype) || isset($single_property->construction) || isset($single_property->dividable) || isset($single_property->noofdrivingdoors) ||
			  ...
			  isset($single_property->noofrestrooms) || isset($single_property->sprinklers) || isset($single_property->utilities)  || isset($single_property->yearbuilt)  || isset($single_property->bldgsqfeet) ||
			  isset($single_property->unmapped->BuildingAreaUnits) || isset($single_property->unmapped->LotSizeUnits) || isset($single_property->unmapped->LotSizeDimensions)  || isset($single_property->sitecondition)  || isset($single_property->totalunits) ||
			  isset($single_property->yearbuiltdescrp) || isset($single_property->zoning) || isset($single_property->roofmaterial)  || isset($single_property->warranty)  || isset($single_property->unmapped->WaterfrontYN) ):?>
	<li class="cell">
		...
		<ul class="zy-sub-list">
				...
				<li>Year Build Description: [yearbuiltdescrp]</li>
				<?php endif; ?>
