		...
		<div class="cell cell-xs-12 cell-lg-8 uk-position-relative">
			<div class="mb-10">
				...
				<div class="grid grid-xs--full grid-md--thirds grid-lg--halves">
					<div class="cell"><i class="zpa-status <?php echo is_numeric($property->status)? 'status_'.str_replace(' ','',$property->status) : str_replace(' ','',$property->status); ?> zy-sash py-5 px-10 zy-listing-single__sash"><?php echo isset($property->status)? zipperagent_get_status_name( $property->status ) :'-'; ?></i></div>
				</div>
			</div>
...
jQuery(document).ready(function ($) {
	...
	// $(document).on('click', '.slider-right', function(e) {
		// var obj = $(this).parent().parent().find('.main-slider .owl-controls .owl-next');
		// obj.click();
	...
	// $(document).on('click', '.slider-left', function(e) {
		// var obj = $(this).parent().parent().find('.main-slider .owl-controls .owl-prev');
		// obj.click();
		// console.log(obj.html());
