			...
			<section class="mt-15 listing-content">
				<div id="listing-top-wrapper" class="grid grid--gutters">
					<div id="gallery-column" class="cell cell-xs-12 cell-lg-8 mb-15">
						...
						<?php if( (isset($single_property->unmapped->VirtualTourURLBranded)) && (isset($single_property->listingAgent) || isset($single_property->salesAgent) || isset($single_property->coListingAgent) || isset($single_property->coSalesAgent)) && (is_branded_virtualtour() == 1)): ?>
						...
						<li class="cell">
							...
							<table class="bt-listing__table">
								...
								<tbody>
									...
									<tr>
										<td class="bt-listing__table__label">Current Use</td>
										<td class="bt-listing__table__items"><span>[unmapped_CurrentUse]</span></td>
									</tr>
									<?php endif; ?>
									...
									<tr>
										<td class="bt-listing__table__label">Town Ship</td>
										<td class="bt-listing__table__items"><span>[unmapped_Township]</span></td>
									</tr>
									<?php endif; ?>
									...
									<tr>
										...
										<td class="bt-listing__table__items"><span>[unmapped_WaterAccess]</span></td>
									</tr>
									<?php endif; ?>
									...
									<tr>
										<td class="bt-listing__table__label">Water View Features</td>
									...
									<tr>
										<td class="bt-listing__table__label">Water Front Feet Total</td>
										<td class="bt-listing__table__items"><span>[unmapped_WaterfrontFeetTotal]</span></td>
									</tr>
									<?php endif; ?>
									<?php if( isset($single_property->unmapped->WaterExtras)): ?>
									<tr>
										<td class="bt-listing__table__label">Water Extras</td>
										<td class="bt-listing__table__items"><span>[unmapped_WaterExtras]</span></td>
									</tr>
									<?php endif; ?>
									<?php if( isset($single_property->unmapped->AdditionalWaterInformation)): ?>
									<tr>
										<td class="bt-listing__table__label">Additional Water Information</td>
										<td class="bt-listing__table__items"><span>[unmapped_AdditionalWaterInformation]</span></td>
									</tr>
									<?php endif; ?>
									...
									<tr>
										<td class="bt-listing__table__label">Vegetation</td>
										<td class="bt-listing__table__items"><span>[unmapped_Vegetation]</span></td>
									</tr>
									<?php endif; ?>
									<?php if( isset($single_property->unmapped->LotSizeSquareFeet)): ?>
									<tr>
										<td class="bt-listing__table__label">Lot Size Square Feet</td>
										<td class="bt-listing__table__items"><span>[unmapped_LotSizeSquareFeet]</span></td>
									</tr>
									<?php endif; ?>
									<?php if( isset($single_property->unmapped->AdditionalRooms)): ?>
									<tr>
										<td class="bt-listing__table__label">Additional Rooms</td>
										<td class="bt-listing__table__items"><span>[unmapped_AdditionalRooms]</span></td>
									</tr>
									<?php endif; ?>
									<?php if( isset($single_property->unmapped->FloodZoneCode)): ?>
									<tr>
										<td class="bt-listing__table__label">Flood Zone Code</td>
										<td class="bt-listing__table__items"><span>[unmapped_FloodZoneCode]</span></td>
									</tr>
									<?php endif; ?>
									<?php if( isset($single_property->unmapped->BuildingElevatorYN)): ?>
									<tr>
										<td class="bt-listing__table__label">Building Elevator</td>
										<td class="bt-listing__table__items"><span>[unmapped_BuildingElevatorYN]</span></td>
									</tr>
									<?php endif; ?>
									<?php if( isset($single_property->disclosures)): ?>
									<tr>
										<td class="bt-listing__table__label">Disclosures</td>
										<td class="bt-listing__table__items"><span>[disclosures]</span></td>
									</tr>
									<?php endif; ?>
									...
									<tr>
										<td class="bt-listing__table__label">Unit Placement</td>
										<td class="bt-listing__table__items"><span>[unitplacement]</span></td>
									</tr>
									<?php endif; ?>
									...
									<tr>
										...
										<td class="bt-listing__table__items"><span>[unmapped_BusinessType]</span></td>
									</tr>
									<?php endif; ?>
									<?php if( isset($single_property->unmapped->NumofConferenceMeetingRooms)): ?>
									<tr>
										<td class="bt-listing__table__label">Numof Conference Meeting Rooms</td>
										<td class="bt-listing__table__items"><span>[unmapped_NumofConferenceMeetingRooms]</span></td>
									</tr>
									<?php endif; ?>
									<?php if( isset($single_property->leasepriceincludes)): ?>
									<tr>
										<td class="bt-listing__table__label">Lease Price Includes</td>
										<td class="bt-listing__table__items"><span>[leasepriceincludes]</span></td>
									</tr>
									<?php endif; ?>
						...
						<?php if( isset($single_property->unmapped->AssociationFeeFrequency) || isset($single_property->unmapped->AssociationFee) || isset($single_property->unmapped->CondoFees) || isset($single_property->unmapped->MonthlyCondoFeeAmount) || isset($single_property->unmapped->CondoFeesTerm) || isset($single_property->asscfeeincludes) || isset($single_property->unmapped->AssociationAmenities) || isset($single_property->unmapped->MonthlyHOAAmount) ):?>
							...
							<table class="bt-listing__table">
								...
								<tbody>
									...
									<tr>
										<td class="bt-listing__table__label">Association Fee Frequency</td>
										<td class="bt-listing__table__items"><span>[unmapped_AssociationFeeFrequency]</span></td>
									</tr>
									<?php endif; ?>
									...
									<tr>
										<td class="bt-listing__table__label">Condo Fees</td>
										<td class="bt-listing__table__items"><span>[unmapped_CondoFees]</span></td>
									</tr>
									<?php endif; ?>
									<?php if( isset($single_property->unmapped->MonthlyCondoFeeAmount)): ?>
									<tr>
										<td class="bt-listing__table__label">Monthly Condo Fee Amount</td>
										<td class="bt-listing__table__items"><span>[unmapped_MonthlyCondoFeeAmount]</span></td>
									</tr>
									<?php endif; ?>
									<?php if( isset($single_property->unmapped->CondoFeesTerm)): ?>
									<tr>
										<td class="bt-listing__table__label">Condo Fees Term</td>
										<td class="bt-listing__table__items"><span>[unmapped_CondoFeesTerm]</span></td>
									</tr>
									<?php endif; ?>
									...
									<tr>
										<td class="bt-listing__table__label">Association Amenities</td>
										<td class="bt-listing__table__items"><span>[unmapped_AssociationAmenities]</span></td>
									</tr>
									<?php endif; ?>
									<?php if( isset($single_property->unmapped->MonthlyHOAAmount)): ?>
									<tr>
										<td class="bt-listing__table__label">Monthly HOA Amount</td>
										<td class="bt-listing__table__items"><span>[unmapped_MonthlyHOAAmount]</span></td>
									</tr>
									<?php endif; ?>						
								</tbody>
							</table>
						...
						<li class="cell">
							...
							<table class="bt-listing__table">
								<tbody>
									...
									<tr>
										<td class="bt-listing__table__label">Tax Block</td>
										<td class="bt-listing__table__items"><span>[unmapped_TaxBlock]</span></td>
									</tr>
									<?php endif; ?>
