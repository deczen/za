...
<header class="slider-header span-page">
	...
	<div class="carousel-nextprev carousel-nav-box">
		<a class="left carousel-control" href="#list-carousel" role="button" data-slide="prev"><img src="<?php echo ZIPPERAGENTPATH; ?>/images/arrow-left.svg" /></a>
		<a class="right carousel-control" href="#list-carousel" role="button" data-slide="next"><img src="<?php echo ZIPPERAGENTPATH; ?>/images/arrow-right.svg" /></a>
	</div>
	<?php endif; ?>
</header>
