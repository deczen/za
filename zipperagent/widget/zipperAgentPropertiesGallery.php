...
class zipperAgentPropertiesGallery extends zipperAgentWidget {
	...
	public function __construct() {
		...
		$this->urlFactory = zipperAgentUrlFactory::getInstance();
	...
	private function hotSheet($args, $instance) {
	 ...
	 private function linkSearch($args, $instance) {
		if($this->displayRules->isLinkSearchEnabled()) {
			...
			$linkUrl = zipperAgentUtility::getInstance()->buildUrl($resultsUrl, $searchParams);
			echo $beforeWidget;
			echo $beforeTitle;
			echo "<a href='" . $linkUrl. "'>" . $linkText . "</a>";
			echo $afterTitle;
