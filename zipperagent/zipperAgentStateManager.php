...
class zipperAgentStateManager {
	
	//stored in session
	const SESSION_ID = "za_session_id";
	const LAST_SEARCH_URL = "za_last_search_url";
	const SEARCH_SUMMARY = "za_search_summary";
	
	//stored as cookie
	const SUBSCRIBER_ID = "za_subscriber_id";
	const REMEMBER_ME = "za_remember_me";
	const LEAD_CAPTURE_USER_ID = "za_lead_capture_user_id";
	 ...
	 * We're currently not using this because we do checks on the ZA servers
	 * @return boolean
	 */
	...
	public function setListingInfo($value) {
		if(is_a($value, "zipperAgentListingInfo")) {
