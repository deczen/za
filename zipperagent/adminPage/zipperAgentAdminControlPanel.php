...
class zipperAgentAdminControlPanel extends zipperAgentAdminAbstractPage {
	...
	protected function getContent() {
		if($this->admin->isActivated()) {
			$url = "http://" . zipperAgentConstants::CONTROL_PANEL_EXTERNAL_URL . "/z.cfm?w=" . get_option(zipperAgentConstants::ACTIVATION_TOKEN_OPTION, null);
			?>
