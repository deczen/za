...
abstract class zipperAgentAdminAbstractPage implements zipperAgentAdminPageInterface {
	...
	public function getPage() {
		...
		?>
		<div id="za-main-container" class="wrap">
			<?php
			$this->getContent();
			?>
		</div>
	...
	public function isUpdated() {
		$settingsUpdated = zipperAgentUtility::getInstance()->getRequestVar("settings-updated");
