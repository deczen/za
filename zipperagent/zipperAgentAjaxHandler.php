...
/**
 * This class is handle all zipperAgent Ajax Requests.
 * It proxies the requests and returns the proper results.
 *
 * @author zipperagent
 */
class zipperAgentAjaxHandler {
	...
	public function photoTour() {
        ...
        if($responsive) {
            $boardId = zipperAgentUtility::getInstance()->getRequestVar("boardID");
	...
	public function saveSearch() {
		...
		$name = zipperAgentUtility::getInstance()->getRequestVar("name");
