...
class zipperAgentListingSoldDetailVirtualPageImpl extends zipperAgentAbstractVirtualPage {
	...
	public function getTitle() {
		...
		return $this->getText(zipperAgentConstants::OPTION_VIRTUAL_PAGE_TITLE_SOLD_DETAIL, $default);
	}
	
	public function getPermalink() {
		return $this->getText(zipperAgentConstants::OPTION_VIRTUAL_PAGE_PERMALINK_TEXT_SOLD_DETAIL, "homes-for-sale-sold-details");
	}
	
	public function getPageTemplate() {
		return get_option(zipperAgentConstants::OPTION_VIRTUAL_PAGE_TEMPLATE_SOLD_DETAIL, null);
	}
	...
	public function getMetaTags() {
		...
		return $this->getText(zipperAgentConstants::OPTION_VIRTUAL_PAGE_META_TAGS_SOLD_DETAIL, $default);
	}
