...
class zipperAgentMenu {
	
	private static $instance;
	
	private $communityPagesMenuItemName = "Communities";
	private $defaultMenuName = "ZipperAgent";
	...
	/**
	 * Creates or retrieves the ZipperAgent menu. If the menu has
	...
	public function addPageToCommunityPages($postId) {
		 $menuID = zipperAgentMenu::getInstance()->getMenuId();
