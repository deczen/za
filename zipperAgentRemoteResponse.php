...
class zipperAgentRemoteResponse {
	...
	public function getSessionId() {
		$result = (string) $this->getProperty("zaSessionId");
		return $result;
	}
	
	public function hasSessionId() {
		return $this->hasProperty("zaSessionId");
	}
