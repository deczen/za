...
return'<td data-day="'+opts.day+'" class="'+arr.join(' ')+'" aria-selected="'+ariaSelected+'">'+'<button class="pika-button pika-day" type="button" '+'data-pika-year="'+opts.year+'" data-pika-month="'+opts.month+'" data-pika-day="'+opts.day+'">'+opts.day+'</button>'+'</td>'},renderWeek=function(d,m,y){var onejan=new Date(y,0,1),weekNum=Math.ceil((((new Date(y,m,d)-onejan)/86400000)+onejan.getDay()+1)/7);return'<td class="pika-week">'+weekNum+'</td>'},renderRow=function(days,isRTL,pickWholeWeek,isRowSelected)
...
if(!hasClass(target,'pika-select')){if(e.preventDefault){e.preventDefault()}else{e.returnValue=!1;return!1}}else{self._c=!0}};self._onChange=function(e)
{e=e||window.event;var target=e.target||e.srcElement;if(!target){return}
...
self._c=!1};self._onClick=function(e)
...
{if(!this.isVisible()){this._v=!0;this.draw();removeClass(this.el,'is-hidden');if(this._o.bound){addEvent(document,'click',this._onClick);this.adjustPosition()}
if(typeof this._o.onOpen==='function'){this._o.onOpen.call(this)}}},hide:function()
{var v=this._v;if(v!==!1){if(this._o.bound){removeEvent(document,'click',this._onClick)}
this.el.style.position='static';this.el.style.left='auto';this.el.style.top='auto';addClass(this.el,'is-hidden');this._v=!1;if(v!==undefined&&typeof this._o.onClose==='function'){this._o.onClose.call(this)}}},destroy:function()
