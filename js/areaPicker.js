	...
	jQuery.fn.areaPicker = function(options) {
		...
		return this.each(function() {
			...
			var loadAreasForAjaxRequests = function(expandAllAreas) {
				...
				jQuery.ajax({
					...
					.done(function(response) {
						...
						jQuery('#za-main-search-form-submit').css('cursor', 'pointer');
						jQuery('.za-advanced-search-launch').css('cursor', 'pointer');
			...
			var updateSelectedItems = function(match) {
				...
				selectedItemDiv.addClass("za-one-selectedArea");
				...
				var selectedItemInput = jQuery("<input type='hidden' data-za-location-field='true' value='" + match.value + "' name='" + fieldName + "'/>");
